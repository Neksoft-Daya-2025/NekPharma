...
class StockistSampleExport implements FromArray, WithHeadings
{
    public function array(): array
    {
        ...
        return [
            [
                'ABC Medical Store',                      // Shop Name (mandatory)
                'Rajesh Kumar',                          // Owner Name (mandatory)
                '9876543210',                            // Owner Mobile (mandatory)
                ...
                'Rajesh Kumar',                          // Stockist Name (optional)
                '9876543210',                            // Mobile (optional)
                'abc.medical@example.com',              // Email (optional)
                'Male',                                  // Gender (optional)
                '01-01-1980',                            // Date of Birth (optional)
                '15-06-2005',                            // Date of Marriage (optional)
                'Ramesh Singh',                          // Employee Name (optional)
                '9876543211'                             // Employee Mobile (optional)
            ],
            [
                'XYZ Pharmacy',                          // Shop Name (mandatory)
                'Priya Sharma',                          // Owner Name (mandatory)
                '9876543212',                            // Owner Mobile (mandatory)
                ...
                'Priya Sharma',                          // Stockist Name (optional)
                '9876543212',                            // Mobile (optional)
                'xyz.pharmacy@example.com',              // Email (optional)
                'Female',                                // Gender (optional)
                '15-03-1985',                            // Date of Birth (optional)
                '',                                      // Date of Marriage (optional)
                '',                                      // Employee Name (optional)
                ''                                       // Employee Mobile (optional)
            ],
            [
                'PQR Drug Store',                        // Shop Name (mandatory)
                'Amit Verma',                           // Owner Name (mandatory)
                '9876543213',                            // Owner Mobile (mandatory)
                ...
                'Amit Verma',                            // Stockist Name (optional)
                '9876543213',                            // Mobile (optional)
                'pqr.drugstore@example.com',             // Email (optional)
                'Male',                                  // Gender (optional)
                '20-05-1990',                            // Date of Birth (optional)
                '',                                      // Date of Marriage (optional)
                'Suresh Yadav',                           // Employee Name (optional)
                '9876543214'                             // Employee Mobile (optional)
            ],
        ];
    }

...
class CompanyObserver
{
    ...
    public function roles($company): void
    {
        ...
        $adminRole->hierarchy_level = 8; // Requirement 2.1: Admin = top of hierarchy
        ...
        // Requirement 2.1: Create eight pharma hierarchy roles (1–7 here; 8 = admin above)
        $pharmaRoles = [
    ...
    public function moduleSettings($company): void
    {
        ...
        $data = [
            'admin' => [
                ...ModuleSetting::CLIENT_MODULES, ...ModuleSetting::OTHER_MODULES, ...ModuleSetting::PHARMA_MODULES
            ],
            'employee' => [
                ...ModuleSetting::CLIENT_MODULES, ...ModuleSetting::OTHER_MODULES, ...ModuleSetting::PHARMA_MODULES
            ],

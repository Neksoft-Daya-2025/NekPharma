...
class AppSettingController extends AccountBaseController
{
    ...
    public function index()
    {
        ...
        $this->view = match ($tab) {
            ...
            'employee-setting' => 'app-settings.ajax.employee-setting',
    ...
    public function update(UpdateAppSetting $request, $id)
    {
        ...
        case 'employee-setting':
            $this->updateEmployeeSetting($request);
            break;
        default:
    ...
    public function updateEmployeeSetting($request)
    {
        $setting = \company();
        $setting->employee_id_prefix = $request->employee_id_prefix ?? 'RVB';
        $setting->save();
    }
    ...
    public function resetCache()
    {
        try {
            ...
            return Reply::error('Failed to clear cache: ' . $e->getMessage());
        }
    }

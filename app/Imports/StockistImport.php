...
class StockistImport implements ToArray
{
    ...
    public static function fields(): array
    {
        return array(
            ...
            array('id' => 'owner_name', 'name' => __('Owner Name'), 'required' => 'Yes'),
            array('id' => 'owner_mobile', 'name' => __('Owner Mobile'), 'required' => 'Yes'),
            ...
            array('id' => 'fullname', 'name' => __('Stockist Name'), 'required' => 'No'),
            ...
            array('id' => 'employee_name', 'name' => __('Employee Name'), 'required' => 'No'),
            array('id' => 'employee_mobile', 'name' => __('Employee Mobile'), 'required' => 'No'),
        );
    }

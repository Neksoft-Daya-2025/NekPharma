...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <div class="alert bg-secondary-transparent alert-dismissible fade show mb-4 d-flex align-items-center justify-content-between gap-2">
                    ...
                    <div class="card position-relative flex-fill">
                        <div class="card-header bg-dark">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <span class="avatar avatar-lg avatar-rounded border border-white border-2 flex-shrink-0 me-2 position-relative">
                                    <img src="{{URL::asset('build/img/users/user-01.jpg')}}" alt="Img">
                                    <span class="position-absolute employee-verify-badge bg-white fs-14 d-inline-flex align-items-center justify-content-center rounded-circle"><i class="ti ti-discount-check-filled text-success"></i></span>
                                </span>
                                <div>
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-12">
                                    <div>
                                        <p class="d-flex align-items-center gap-2"><span class="square-icon rounded bg-primary"><i class="ti ti-check text-white fs-10 fw-bold"></i></span>Better than  <span class="text-gray-9">85%</span> of Employees</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                <h5>Projects</h5>
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="btn btn-white border-0 dropdown-toggle dropdown-sm border btn-sm d-inline-flex align-items-center" data-bs-toggle="dropdown">
                                        Ongoing Projects
                                    </a>
                                    <ul class="dropdown-menu  dropdown-menu-end p-3">
                                        <li>
                            ...
                            <div>
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="d-block border border-2 h-12 border-primary rounded-5 me-2 left-line"></span>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="d-block border border-2 h-12 border-success rounded-5 me-2 left-line"></span>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="d-block border border-2 h-12 border-purple rounded-5 me-2 left-line"></span>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="d-block border border-2 h-12 border-info rounded-5 me-2 left-line"></span>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="d-block border border-2 h-12 border-dark rounded-5 me-2 left-line"></span>
                                            <div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                <h5>Team Members</h5>
                                <div>
                                <a href="#" class="btn btn-light btn-md">View All</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">

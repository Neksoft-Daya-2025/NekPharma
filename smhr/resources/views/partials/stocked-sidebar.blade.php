    ...
    <div class="stacked-sidebar" id="stacked-sidebar">
        <div class="sidebar sidebar-stacked" style="display: flex !important;">
            ...
            <div class="sidebar-right d-flex justify-content-between flex-column">
                <div class="sidebar-scroll">
                    ...
                    <div class="stack-menu">
                        <div class="nav flex-column align-items-center nav-pills" role="tablist" aria-orientation="vertical">
                            <div class="row g-2">
                                <div class="col-6">
                                    <a href="#menu-dashboard" role="tab" class="nav-link {{ Request::is('index', '/', 'employee-dashboard', 'deals-dashboard', 'leads-dashboard', 'hr-dashboard', 'payroll-dashboard', 'recruitment-dashboard', 'attendance-dashboard', 'finance-dashboard', 'it-admin-dashboard', 'asset-dashboard', 'help-desk-dashboard') ? 'active ' : '' }}" title="Dashboard" data-bs-toggle="tab" data-bs-target="#menu-dashboard" aria-selected="true">
                                        <span><i class="ti ti-smart-home"></i></span>
                                        <p>Dashboard</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-application" role="tab" class="nav-link {{ Request::is('chat', 'voice-call', 'video-call', 'outgoing-call', 'incoming-call', 'call-history', 'calendar', 'email', 'email-reply', 'todo', 'todo-list', 'notes', 'social-feed', 'file-manager', 'kanban-view', 'invoices', 'add-invoices', 'edit-invoices', 'invoice-details') ? 'active' : '' }}" title="Apps" data-bs-toggle="tab" data-bs-target="#menu-application" aria-selected="false">
                                        <span><i class="ti ti-layout-grid-add"></i></span>
                                        <p>Applications</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-superadmin" role="tab" class="nav-link {{ Request::is('dashboard', 'companies', 'subscription', 'packages', 'packages-grid', 'domain', 'purchase-transaction', 'tenant-usage-metrics', 'tenant-support-tickets', 'tenant-ticket-details', 'agents', 'sla-policies', 'escalation-rules') ? 'active' : '' }}" title="Apps" data-bs-toggle="tab" data-bs-target="#menu-superadmin" aria-selected="false">
                                        <span><i class="ti ti-user-star"></i></span>
                                        <p>Super Admin</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-layout" role="tab" class="nav-link {{ Request::is('layout-horizontal', 'layout-detached', 'layout-modern', 'layout-two-column', 'layout-hovered', 'layout-box', 'layout-horizontal-single', 'layout-horizontal-overlay', 'layout-horizontal-box', 'layout-horizontal-sidemenu', 'layout-vertical-transparent', 'layout-without-header', 'layout-rtl', 'layout-dark') ? 'active' : '' }}" title="Layout" data-bs-toggle="tab" data-bs-target="#menu-layout" aria-selected="false">
                                        <span><i class="ti ti-layout-board-split"></i></span>
                                        <p>Layouts</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-project" role="tab" class="nav-link {{ Request::is('clients-grid', 'projects-grid', 'projects', 'project-details', 'tasks', 'task-board') ? 'active ' : '' }}" title="Projects" data-bs-toggle="tab" data-bs-target="#menu-project" aria-selected="false">
                                        <span><i class="ti ti-folder"></i></span>
                                        <p>Projects</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-crm" role="tab" class="nav-link {{ Request::is('contacts-grid', 'companies-grid', 'deals-grid', 'leads-grid', 'leads-details', 'leads', 'pipeline', 'analytics', 'activity') ? ' show active ' : '' }}" title="CRM" data-bs-toggle="tab" data-bs-target="#menu-crm" aria-selected="false">
                                        <span><i class="ti ti-user-shield"></i></span>
                                        <p>Crm</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-hrm" role="tab" class="nav-link {{ Request::is('employees', 'employees-grid', 'employee-details', 'departments', 'designations', 'policy', 'tickets', 'ticket-details', 'ticket-automation', 'ticket-reports', 'holidays', 'leaves', 'leaves-employee', 'leave-settings', 'attendance-admin', 'attendance-employee', 'timesheets', 'schedule-timing', 'overtime', 'holiday-calendar', 'shift-swap-requests', 'work-from-home', 'performance-indicator', 'performance-review', 'performance-appraisal', 'goal-tracking', 'goal-type', 'training', 'trainers', 'training-type', 'certification-tracking', 'learning-analytics', 'probation-management', 'notice-period-tracker', 'promotion', 'resignation', 'termination', 'job-grid', 'job-list', 'candidates-grid', 'candidates-kanban', 'candidates', 'refferals', 'resume-parsing', 'campus-hiring') ? '  active ' : '' }}" title="HRM" data-bs-toggle="tab" data-bs-target="#menu-hrm" aria-selected="false">
                                        <span><i class="ti ti-users"></i></span>
                                        <p>Hrm</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-finance" role="tab" class="nav-link {{ Request::is('estimates', 'invoice', 'payments', 'expenses', 'provident-fund', 'taxes', 'categories', 'budgets', 'budget-expenses', 'budget-revenues', 'employee-salary', 'payslip', 'payroll', 'payroll-overtime', 'payroll-deduction') ? ' show active ' : '' }}" title="Finance & Accounts" data-bs-toggle="tab" data-bs-target="#menu-finance" aria-selected="false">
                                        <span><i class="ti ti-shopping-cart-dollar"></i></span>
                                        <p>Finance & Accounts</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-administration" role="tab" class="nav-link {{ Request::is('assets', 'asset-categories', 'assets', 'asset-categories', 'knowledgebase', 'knowledgebase-details', 'knowledgebase-view', 'users', 'roles-permissions', 'permission', 'expenses-report', 'invoice-report', 'payment-report', 'project-report', 'task-report', 'user-report', 'employee-report', 'payslip-report', 'attendance-report', 'leave-report', 'daily-report', 'profile-settings', 'security-settings', 'notification-settings', 'connected-apps', 'business-settings', 'seo-settings', 'localization-settings', 'prefixes', 'preferences', 'appearance', 'language', 'add-language', 'language-web', 'authentication-settings', 'ai-settings', 'salary-settings', 'approval-settings', 'invoice-settings', 'leave-type', 'custom-fields', 'email-settings', 'email-template', 'sms-settings', 'sms-template', 'otp-settings', 'gdpr', 'maintenance-mode', 'payment-gateways', 'tax-rates', 'currencies', 'custom-css', 'custom-js', 'cronjob', 'storage-settings', 'ban-ip-address', 'backup', 'clear-cache') ? ' active' : '' }}" title="Administration" data-bs-toggle="tab" data-bs-target="#menu-administration" aria-selected="false">
                                        <span><i class="ti ti-cash"></i></span>
                                        <p>Administration</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-content" role="tab" class="nav-link {{ Request::is('pages', 'blogs', 'blog-categories', 'blog-comments', 'blog-tags', 'countries', 'states', 'cities', 'testimonials', 'faq') ? 'active' : '' }}" title="Content" data-bs-toggle="tab" data-bs-target="#menu-content" aria-selected="false">
                                        <span><i class="ti ti-license"></i></span>
                                        <p>Contents</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-pages" role="tab" class="nav-link {{ Request::is('starter', 'profile', 'gallery', 'search-result', 'timeline', 'pricing', 'coming-soon', 'under-maintenance', 'under-construction', 'api-keys', 'privacy-policy', 'terms-condition') ? 'active' : '' }}" title="Pages"
                                ...
                                <div class="col-6">
                                    <a href="#menu-authentication" role="tab" class="nav-link {{ Request::is('login', 'login-2', 'login-3', 'register', 'register-2', 'register-3', 'forgot-password', 'forgot-password-2', 'forgot-password-3', 'reset-password', 'reset-password-2', 'reset-password-3', 'email-verification', 'email-verification-2', 'email-verification-3', 'two-step-verification', 'two-step-verification-2', 'two-step-verification-3', 'lock-screen', 'error-404', 'error-500') ? '  active' : '' }}" title="Authentication" data-bs-toggle="tab" data-bs-target="#menu-authentication" aria-selected="false">
                                        <span><i class="ti ti-lock-check"></i></span>
                                        <p>Authentication</p>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="#menu-ui-elements" role="tab" class="nav-link {{ Request::is('ui-alerts', 'ui-accordion', 'ui-avatar', 'ui-badges', 'ui-borders', 'ui-buttons', 'ui-buttons-group', 'ui-breadcrumb', 'ui-cards', 'ui-carousel', 'ui-colors', 'ui-dropdowns', 'ui-grid', 'ui-images', 'ui-lightbox', 'ui-media', 'ui-modals', 'ui-offcanvas', 'ui-pagination', 'ui-popovers', 'ui-progress', 'ui-placeholders' , 'ui-spinner', 'ui-sweetalerts', 'ui-nav-tabs', 'ui-toasts', 'ui-tooltips', 'ui-typography', 'ui-video', 'ui-ribbon', 'ui-clipboard', 'ui-drag-drop', 'ui-rangeslider', 'ui-rating', 'ui-text-editor', 'ui-counter', 'ui-scrollbar', 'ui-stickynote', 'ui-timeline', 'form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-mask', 'form-fileupload', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'form-validation', 'form-wizard', 'form-select2', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'tables-basic', 'data-tables', 'chart-apex', 'chart-js', 'chart-morris', 'chart-flot', 'chart-peity', 'chart-c3', 'icon-fontawesome', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag', 'maps-vector', 'maps-leaflet') ? 'active' : '' }}" title="UI Elements" data-bs-toggle="tab" data-bs-target="#menu-ui-elements" aria-selected="false">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade {{ Request::is('index', '/', 'employee-dashboard', 'deals-dashboard', 'leads-dashboard', 'hr-dashboard', 'payroll-dashboard', 'recruitment-dashboard', 'attendance-dashboard', 'finance-dashboard', 'it-admin-dashboard', 'asset-dashboard', 'help-desk-dashboard') ? ' show active ' : '' }}" id="menu-dashboard">
                                <ul class="stack-submenu">
                                    ...
                                    <li><a href="{{url('hr-dashboard')}}" class="{{ Request::is('hr-dashboard') ? 'active' : '' }}">HR Dashboard</a></li>
                                    <li><a href="{{url('payroll-dashboard')}}" class="{{ Request::is('payroll-dashboard') ? 'active' : '' }}">Payroll Dashboard</a></li>
                                    <li><a href="{{url('recruitment-dashboard')}}" class="{{ Request::is('recruitment-dashboard') ? 'active' : '' }}">Recruitment Dashboard</a></li>
                                    <li><a href="{{url('attendance-dashboard')}}" class="{{ Request::is('attendance-dashboard') ? 'active' : '' }}">Attendance Dashboard</a></li>
                                    <li><a href="{{url('finance-dashboard')}}" class="{{ Request::is('finance-dashboard') ? 'active' : '' }}">Finance Dashboard</a></li>
                                    <li><a href="{{url('it-admin-dashboard')}}" class="{{ Request::is('it-admin-dashboard') ? 'active' : '' }}">IT Admin Dashboard</a></li>
                                    <li><a href="{{url('asset-dashboard')}}" class="{{ Request::is('asset-dashboard') ? 'active' : '' }}">Asset Dashboard</a></li>
                                    <li><a href="{{url('help-desk-dashboard')}}" class="{{ Request::is('help-desk-dashboard') ? 'active' : '' }}">Help Desk Dashboard</a></li>
                                </ul>
                            </div>
                            <div class="tab-pane fade {{ Request::is('dashboard', 'companies', 'subscription', 'packages', 'packages-grid', 'domain', 'purchase-transaction', 'tenant-usage-metrics', 'tenant-support-tickets', 'tenant-ticket-details', 'agents', 'sla-policies', 'escalation-rules') ? ' show active' : '' }}" id="menu-superadmin">
                                <ul class="stack-submenu">
                                    ...
                                    <li><a href="{{url('tenant-usage-metrics')}}" class="{{ Request::is('tenant-usage-metrics') ? 'active' : '' }}">Tenant Usage Metrics</a></li>
                                    <li><a href="{{url('tenant-support-tickets')}}" class="{{ Request::is('tenant-support-tickets', 'tenant-ticket-details') ? 'active' : '' }}">Tenant Support Tickets</a></li>
                                    <li class="submenu submenu-two">
                                        <a href="#" class="{{ Request::is('agents', 'sla-policies', 'escalation-rules') ? 'active subdrop' : '' }}">Tickets<span class="menu-arrow inside-submenu"></span></a>
                                        <ul>
                                            <li><a href="{{url('agents')}}" class="{{ Request::is('agents') ? 'active' : '' }}">Agents</a></li>
                                            <li><a href="{{url('sla-policies')}}" class="{{ Request::is('sla-policies') ? 'active' : '' }}">SLA Policies</a></li>
                                            <li><a href="{{url('escalation-rules')}}" class="{{ Request::is('escalation-rules') ? 'active' : '' }}">Escalation Rules</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-pane fade {{ Request::is('chat', 'voice-call', 'video-call', 'outgoing-call', 'incoming-call', 'call-history', 'calendar', 'email', 'email-reply', 'todo', 'todo-list', 'notes', 'social-feed', 'file-manager', 'kanban-view', 'invoices', 'add-invoices', 'edit-invoices', 'invoice-details') ? ' show active ' : '' }}" id="menu-application">
                                <ul class="stack-submenu">
                                    ...
                                    <li><a href="{{url('invoices')}}" class="{{ Request::is('invoices', 'add-invoices', 'edit-invoices', 'invoice-details') ? 'active' : '' }}">Invoices</a></li>
                                </ul>
                            </div>
                            <div class="tab-pane fade {{ Request::is('layout-horizontal', 'layout-detached', 'layout-modern', 'layout-two-column', 'layout-hovered', 'layout-box', 'layout-horizontal-single', 'layout-horizontal-overlay', 'layout-horizontal-box', 'layout-horizontal-sidemenu', 'layout-vertical-transparent', 'layout-without-header', 'layout-rtl', 'layout-dark') ? ' show active' : '' }}" id="menu-layout">
                                <ul class="stack-submenu">
                                    ...
                                    <li><a href="{{url('layout-box')}}" class="{{ Request::is('layout-box') ? 'active' : '' }}">Boxed</a></li>
                                    <li><a href="{{url('layout-horizontal-single')}}" class="{{ Request::is('layout-horizontal-single') ? 'active' : '' }}">Horizontal Single</a></li>
                                    <li><a href="{{url('layout-horizontal-overlay')}}" class="{{ Request::is('layout-horizontal-overlay') ? 'active' : '' }}">Horizontal Overlay</a></li>
                                    <li><a href="{{url('layout-horizontal-box')}}" class="{{ Request::is('layout-horizontal-box') ? 'active' : '' }}">Horizontal Box</a></li>
                                    <li><a href="{{url('layout-horizontal-sidemenu')}}" class="{{ Request::is('layout-horizontal-sidemenu') ? 'active' : '' }}">Menu Aside</a></li>
                                    <li><a href="{{url('layout-vertical-transparent')}}" class="{{ Request::is('layout-vertical-transparent') ? 'active' : '' }}">Transparent</a></li>
                                    <li><a href="{{url('layout-without-header')}}" class="{{ Request::is('layout-without-header') ? 'active' : '' }}">Without Header</a></li>
                            ...
                            <div class="tab-pane fade {{ Request::is('clients-grid', 'projects-grid', 'projects', 'project-details', 'tasks', 'task-board') ? 'show active ' : '' }}" id="menu-project">
                                <ul class="stack-submenu">
                                    <li><a href="{{url('clients-grid')}}" class="{{ Request::is('clients-grid') ? 'active' : '' }}"><span>Clients</span></a></li>
                                    <li class="submenu">
                                        <a href="javascript:void(0);"class="{{ Request::is('projects-grid', 'projects', 'project-details', 'tasks', 'task-board') ? 'active subdrop' : '' }}"><span>Projects</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                                            <li><a href="{{url('projects-grid')}}" class="{{ Request::is('projects-grid', 'projects', 'project-details') ? 'active' : '' }}">Projects</a></li>
                            ...
                            <div class="tab-pane fade {{ Request::is('contacts-grid', 'companies-grid', 'deals-grid', 'leads-grid', 'leads-details', 'leads', 'pipeline', 'analytics', 'activity') ? ' show active ' : '' }}" id="menu-crm">
                                <ul class="stack-submenu">
                                    <li><a href="{{url('contacts-grid')}}" class="{{ Request::is('contacts-grid') ? 'active' : '' }}"><span>Contacts</span></a></li>
                                    <li><a href="{{url('companies-grid')}}" class="{{ Request::is('companies-grid') ? 'active' : '' }}"><span>Companies</span></a></li>
                                    <li><a href="{{url('deals-grid')}}" class="{{ Request::is('deals-grid') ? 'active' : '' }}"><span>Deals</span></a></li>
                            ...
                            <div class="tab-pane fade {{ Request::is('employees', 'employees-grid', 'employee-details', 'departments', 'designations', 'policy', 'tickets', 'ticket-details', 'holidays', 'leaves', 'leaves-employee', 'leave-settings', 'attendance-admin', 'attendance-employee', 'timesheets', 'schedule-timing', 'overtime', 'holiday-calendar', 'shift-swap-requests', 'work-from-home', 'performance-indicator', 'performance-review', 'performance-appraisal', 'goal-tracking', 'goal-type', 'training', 'trainers', 'training-type', 'certification-tracking', 'learning-analytics', 'probation-management', 'notice-period-tracker', 'promotion', 'resignation', 'termination', 'job-grid', 'job-list', 'candidates-grid', 'candidates-kanban', 'candidates', 'refferals', 'resume-parsing', 'campus-hiring') ? ' show active ' : '' }}" id="menu-hrm">
                                <ul class="stack-submenu">
                                    <li class="submenu">
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);"class="{{ Request::is('tickets', 'ticket-details', 'ticket-automation', 'ticket-reports') ? 'active subdrop' : '' }}"><span>Tickets</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                                            ...
                                            <li><a href="{{url('ticket-automation')}}" class="{{ Request::is('ticket-automation') ? 'active' : '' }}">Ticket Automation</a></li>
                                            <li><a href="{{url('ticket-reports')}}" class="{{ Request::is('ticket-reports') ? 'active' : '' }}">Ticket Reports</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="{{url('holidays')}}" class="{{ Request::is('holidays') ? 'active' : '' }}"><span>Holidays</span></a></li>
                                    <li class="submenu">
                                        <a href="javascript:void(0);"class="{{ Request::is('leaves', 'leaves-employee', 'leave-settings', 'attendance-admin', 'attendance-employee', 'timesheets', 'schedule-timing', 'overtime', 'holiday-calendar', 'shift-swap-requests', 'work-from-home') ? 'active subdrop' : '' }}"><span>Attendance</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                                            <li class="submenu submenu-two">
                                            ...
                                            <li><a href="{{url('shift-swap-requests')}}" class="{{ Request::is('shift-swap-requests') ? 'active' : '' }}">Shift Swap Requests</a></li>
                                            <li><a href="{{url('overtime')}}" class="{{ Request::is('overtime') ? 'active' : '' }}">Overtime</a></li>
                                            <li><a href="{{url('holiday-calendar')}}" class="{{ Request::is('holiday-calendar') ? 'active' : '' }}">Holiday Calendar</a></li>
                                            <li><a href="{{url('work-from-home')}}" class="{{ Request::is('work-from-home') ? 'active' : '' }}">WFH Management</a></li>
                                        </ul>
                                    </li>
                                    <li class="submenu">
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);"class="{{ Request::is('training', 'trainers', 'training-type', 'certification-tracking', 'learning-analytics') ? 'active subdrop' : '' }}"><span>Training</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                                            ...
                                            <li><a href="{{url('certification-tracking')}}" class="{{ Request::is('certification-tracking') ? 'active' : '' }}"><span>Certification Tracking</span></a></li>
                                            <li><a href="{{url('learning-analytics')}}" class="{{ Request::is('learning-analytics') ? 'active' : '' }}">Learning Analytics</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="{{url('probation-management')}}" class="{{ Request::is('probation-management') ? 'active' : '' }}"><span>Probation Management</span></a></li>
                                    <li><a href="{{url('notice-period-tracker')}}" class="{{ Request::is('notice-period-tracker') ? 'active' : '' }}"><span>Notice Period Tracker</span></a></li>
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('job-grid', 'job-list', 'candidates-grid', 'candidates-kanban', 'candidates', 'refferals', 'resume-parsing', 'campus-hiring') ? 'active subdrop' : '' }}"><span>Recruitment</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                                            <li><a href="{{url('job-grid')}}" class="{{ Request::is('job-grid', 'job-list') ? 'active' : '' }}">Jobs</a></li>
                                            <li><a href="{{url('candidates-grid')}}" class="{{ Request::is('candidates-grid', 'candidates-kanban', 'candidates') ? 'active' : '' }}">Candidates</a></li>
                                            <li><a href="{{url('refferals')}}" class="{{ Request::is('refferals') ? 'active' : '' }}">Referrals</a></li>
                                            <li><a href="{{url('resume-parsing')}}" class="{{ Request::is('resume-parsing') ? 'active' : '' }}">Resume Parsing</a></li>
                                            <li><a href="{{url('campus-hiring')}}" class="{{ Request::is('campus-hiring') ? 'active' : '' }}">Campus Hiring</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-pane fade {{ Request::is('estimates', 'invoice', 'payments', 'expenses', 'provident-fund', 'taxes', 'categories', 'budgets', 'budget-expenses', 'budget-revenues', 'employee-salary', 'payslip', 'payroll', 'payroll-overtime', 'payroll-deduction') ? ' show active ' : '' }}" id="menu-finance">
                                <ul class="stack-submenu">
                                    <li class="submenu">
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('employee-salary', 'payslip', 'payroll', 'payroll-overtime', 'payroll-deduction') ? 'active subdrop' : '' }}"><span>Payroll</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                                            ...
                                            <li><a href="{{url('payroll')}}" class="{{ Request::is('payroll', 'payroll-overtime', 'payroll-deduction') ? 'active' : '' }}">Payroll Items</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-pane fade {{ Request::is('assets', 'asset-categories', 'assets', 'asset-categories', 'knowledgebase', 'knowledgebase-details', 'knowledgebase-view', 'users', 'roles-permissions', 'permission', 'expenses-report', 'invoice-report', 'payment-report', 'project-report', 'task-report', 'user-report', 'employee-report', 'payslip-report', 'attendance-report', 'leave-report', 'daily-report', 'profile-settings', 'security-settings', 'notification-settings', 'connected-apps', 'business-settings', 'seo-settings', 'localization-settings', 'prefixes', 'preferences', 'appearance', 'language', 'add-language', 'language-web', 'authentication-settings', 'ai-settings', 'salary-settings', 'approval-settings', 'invoice-settings', 'leave-type', 'custom-fields', 'email-settings', 'email-template', 'sms-settings', 'sms-template', 'otp-settings', 'gdpr', 'maintenance-mode', 'payment-gateways', 'tax-rates', 'currencies', 'custom-css', 'custom-js', 'cronjob', 'storage-settings', 'ban-ip-address', 'backup', 'clear-cache') ? 'show active' : '' }}" id="menu-administration">
                                <ul class="stack-submenu">
                                    <li class="submenu">
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('knowledgebase', 'knowledgebase-details', 'knowledgebase-view') ? 'active subdrop' : '' }}"><span>Help & Supports</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                                            <li><a href="{{url('knowledgebase')}}" class="{{ Request::is('knowledgebase', 'knowledgebase-details', 'knowledgebase-view') ? 'active' : '' }}">Knowledge Base</a></li>
                                            <li><a href="{{url('activity')}}">Activities</a></li>
                                        </ul>
                                    </li>
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('users', 'roles-permissions', 'permission') ? 'active subdrop' : '' }}"><span>User Management</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                                            <li><a href="{{url('users')}}" class="{{ Request::is('users') ? 'active' : '' }}">Users</a></li>
                                            <li><a href="{{url('roles-permissions')}}" class="{{ Request::is('roles-permissions', 'permission') ? 'active' : '' }}">Roles & Permissions</a></li>
                                        </ul>
                                    </li>
                                    <li class="submenu">
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('business-settings', 'seo-settings', 'localization-settings', 'prefixes', 'preferences', 'appearance', 'language', 'add-language', 'language-web', 'authentication-settings', 'ai-settings') ? 'active subdrop' : '' }}">
                                            Website Settings
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                                            ...
                                            <li><a href="{{url('language')}}" class="{{ Request::is('language', 'add-language', 'language-web') ? 'active' : '' }}">Language</a></li>
                            ...
                            <div class="tab-pane fade {{ Request::is('pages', 'blogs', 'blog-categories', 'blog-comments', 'blog-tags', 'countries', 'states', 'cities', 'testimonials', 'faq') ? ' show active' : '' }}" id="menu-content">
                                <ul class="stack-submenu">
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('blogs', 'blog-categories', 'blog-comments', 'blog-tags') ? 'active subdrop' : '' }}">Blogs<span class="menu-arrow"></span></a>
                                        <ul>
                                            ...
                                            <li><a href="{{url('blog-tags')}}" class="{{ Request::is('blog-tags') ? 'active' : '' }}">Tags</a></li>
                                        </ul>
                                    </li>
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('countries', 'states', 'cities') ? 'active subdrop' : '' }}">Locations<span class="menu-arrow"></span></a>
                                        <ul>
                            ...
                            <div class="tab-pane fade {{ Request::is('starter', 'profile', 'gallery', 'search-result', 'timeline', 'pricing', 'coming-soon', 'under-maintenance', 'under-construction', 'api-keys', 'privacy-policy', 'terms-condition') ? ' show active' : '' }}" id="menu-pages">
                                <ul class="stack-submenu">
                                    <li><a href="{{url('starter')}}" class="{{ Request::is('starter') ? 'active' : '' }}">Starter</a></li>
                                    <li><a href="{{url('profile')}}" class="{{ Request::is('profile') ? 'active' : '' }}">Profile</a></li>
                                    <li><a href="{{url('profile-settings')}}" class="{{ Request::is('profile-settings') ? 'active' : '' }}">Profile Settings</a></li>
                                    <li><a href="{{url('gallery')}}" class="{{ Request::is('gallery') ? 'active' : '' }}">Gallery</a></li>
                                    <li><a href="{{url('search-result')}}" class="{{ Request::is('search-result') ? 'active' : '' }}">Search Results</a></li>
                                    <li><a href="{{url('timeline')}}" class="{{ Request::is('timeline') ? 'active' : '' }}">Timeline</a></li>
                                    ...
                                    <li><a href="{{url('under-construction')}}" class="{{ Request::is('under-construction') ? 'active' : '' }}">Under Construction</a></li>
                                    <li><a href="{{url('api-keys')}}" class="{{ Request::is('api-keys') ? 'active' : '' }}">API Keys</a></li>
                                    <li><a href="{{url('privacy-policy')}}" class="{{ Request::is('privacy-policy') ? 'active' : '' }}">Privacy Policy</a></li>
                                    <li><a href="{{url('terms-condition')}}" class="{{ Request::is('terms-condition') ? 'active' : '' }}">Terms & Conditions</a></li>
                                </ul>
                            </div>
                            <div class="tab-pane fade {{ Request::is('login', 'login-2', 'login-3', 'register', 'register-2', 'register-3', 'forgot-password', 'forgot-password-2', 'forgot-password-3', 'reset-password', 'reset-password-2', 'reset-password-3', 'email-verification', 'email-verification-2', 'email-verification-3', 'two-step-verification', 'two-step-verification-2', 'two-step-verification-3', 'lock-screen', 'error-404', 'error-500') ? ' show active' : '' }}" id="menu-authentication">
                                <ul class="stack-submenu">
                                    <li class="submenu">
                            ...
                            <div class="tab-pane fade {{ Request::is('ui-alerts', 'ui-accordion', 'ui-avatar', 'ui-badges', 'ui-borders', 'ui-buttons', 'ui-buttons-group', 'ui-breadcrumb', 'ui-cards', 'ui-carousel', 'ui-colors', 'ui-dropdowns', 'ui-grid', 'ui-images', 'ui-lightbox', 'ui-media', 'ui-modals', 'ui-offcanvas', 'ui-pagination', 'ui-popovers', 'ui-progress', 'ui-placeholders' , 'ui-spinner', 'ui-sweetalerts', 'ui-nav-tabs', 'ui-toasts', 'ui-tooltips', 'ui-typography', 'ui-video', 'ui-ribbon', 'ui-clipboard', 'ui-drag-drop', 'ui-rangeslider', 'ui-rating', 'ui-text-editor', 'ui-counter', 'ui-scrollbar', 'ui-stickynote', 'ui-timeline', 'form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-mask', 'form-fileupload', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'form-validation', 'form-wizard', 'form-select2', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'tables-basic', 'data-tables', 'chart-apex', 'chart-js', 'chart-morris', 'chart-flot', 'chart-peity', 'chart-c3', 'icon-fontawesome', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag', 'maps-vector', 'maps-leaflet') ? 'show active' : '' }}" id="menu-ui-elements">
                                <ul class="stack-submenu">
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('ui-ribbon', 'ui-clipboard', 'ui-drag-drop', 'ui-rangeslider', 'ui-rating', 'ui-text-editor', 'ui-counter', 'ui-scrollbar', 'ui-stickynote', 'ui-timeline') ? 'subdrop active' : '' }}"> Advanced UI<span class="menu-arrow"></span></a>
                                        <ul>
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-mask', 'form-fileupload', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'form-validation', 'form-wizard', 'form-select2') ? 'subdrop active' : '' }}">Forms<span class="menu-arrow"></span> </a>
                                        <ul>
                                            <li class="submenu submenu-two">
                                                <a href="javascript:void(0);" class="{{ Request::is('form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-mask', 'form-fileupload' ) ? 'subdrop active' : '' }}">Form Elements<span class="menu-arrow inside-submenu"></span></a>
                                                <ul>
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('tables-basic', 'data-tables') ? 'subdrop active' : '' }}">Tables<span class="menu-arrow"></span></a>
                                        <ul>
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('chart-apex', 'chart-js', 'chart-morris', 'chart-flot', 'chart-peity', 'chart-c3') ? 'subdrop active' : '' }}">Charts<span class="menu-arrow"></span> </a>
                                        <ul>
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('icon-fontawesome', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag') ? 'subdrop active' : '' }}">Icons<span class="menu-arrow"></span> </a>
                                        <ul>
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);" class="{{ Request::is('maps-vector', 'maps-leaflet') ? 'subdrop active' : '' }}">
                                            <span>Maps</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul>
                ...
                <div class="p-3">
                    <a href="https://smarthr.dreamstechnologies.com/laravel/documentation/index.html" class="d-flex align-items-center fs-12 mb-3" targer="_blank">Documentation</a>
                    <a href="https://smarthr.dreamstechnologies.com/laravel/documentation/changelog.html" class="d-flex align-items-center fs-12" targer="_blank">Change Log<span class="badge bg-pink badge-xs text-white fs-10 ms-2">v1.8.0</span></a>
                </div>
            </div>
        </div>
    </div>

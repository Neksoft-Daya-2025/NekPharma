                        ...
                        <div class="card-body pb-0">
                            <div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="badge badge-outline-success border border-success bg-success-transparent rounded-pill me-1"><i class="ti ti-arrow-up"></i>12%</span>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar rounded-circle border bg-white flex-shrink-0 me-2">
                                                <img src="{{URL::asset('build/img/company/company-24.svg')}}" class="w-auto h-auto p-1" alt="Img">
                                            </a>
                                            <div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                ...
                                <div>
                                    <a href="{{url('countries')}}" class="btn btn-light btn-md">View All</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="text-center mb-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <span class="badge badge-soft-danger border-danger border rounded-pill"><i class="ti ti-arrow-narrow-down me-1"></i> 12%</span>
                                </div>
                            </div>
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <div class="d-flex align-items-center"><a href="#" class="btn btn-light btn-icon btn-sm d-flex justify-content-center align-items-center border-0 p-2"><i class="ti ti-phone fs-16"></i></a>
                                </div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                ...
                <div class="col-xl-8 d-flex">
                    <div class="card flex-fill">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                            ...
                            <div class="d-flex align-items-center">
                                <div>
                                    <a href="{{url('deals')}}" class="btn btn-md btn-light">View All</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                ...
                                <div>
                                    <a href="{{url('activity')}}" class="btn btn-md btn-light">View All</a>
                                </div>
                            </div>
                        </div>

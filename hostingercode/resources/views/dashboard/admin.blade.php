...
@section('filter-section')
    ...
    <div class="d-flex filter-box project-header bg-white dashboard-header">
        ...
        <div class="project-menu d-lg-flex" id="mob-client-detail">
            ...
            @php
                $hasFieldForceAccess = in_array(user()->permission('approve_dcr_reports'), ['all', 'added', 'owned'])
                    || in_array(user()->permission('approve_tours'), ['all', 'added', 'owned'])
                    || in_array(user()->permission('approve_expenses'), ['all', 'added', 'owned']);
            @endphp
            @if ($hasFieldForceAccess && (in_array('dcr_reports', user_modules()) || in_array('tours', user_modules()) || in_array('expenses', user_modules())))
                <x-tab :href="route('dashboard.advanced').'?tab=field-force'" :text="__('app.menu.fieldForce')"
                       class="field-force" ajax="false"/>
            @endif

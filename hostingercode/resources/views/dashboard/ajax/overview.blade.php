...
{{-- Row 1: Pharma - Doctors, Stockists, Chemists, CFA Stockists, Medical Representatives --}}
<div class="row">
    @if (in_array('doctors', user_modules()) && in_array('total_doctors', $activeWidgets))
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="{{ route('doctors.index') }}">
                <x-cards.widget :title="__('modules.dashboard.totalDoctors')" :value="$counts->totalDoctors"
                                icon="user-md">
                </x-cards.widget>
            </a>
        </div>
    ...
    @if (in_array('stockists', user_modules()) && in_array('total_stockists', $activeWidgets))
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="{{ route('stockists.index') }}">
                <x-cards.widget :title="__('modules.dashboard.totalStockists')" :value="$counts->totalStockists"
                                icon="warehouse">
                </x-cards.widget>
            </a>
        </div>
    ...
    @if (in_array('chemists', user_modules()) && in_array('total_chemists', $activeWidgets))
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="{{ route('chemists.index') }}">
                <x-cards.widget :title="__('modules.dashboard.totalChemists')" :value="$counts->totalChemists"
                                icon="flask">
                </x-cards.widget>
            </a>
        </div>
    ...
    @if (in_array('clients', user_modules()) && in_array('total_cfa_stockists', $activeWidgets))
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="{{ route('cfa-stockists.index') }}">
                <x-cards.widget :title="__('modules.dashboard.totalCfaStockists')" :value="$counts->totalCfaStockists ?? 0"
                                icon="store">
                </x-cards.widget>
            </a>
        </div>
    ...
    @if (in_array('employees', user_modules()) && in_array('total_medical_representatives', $activeWidgets))
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="{{ route('employees.index') }}">
                <x-cards.widget :title="__('modules.dashboard.totalMedicalRepresentatives')" :value="$counts->totalMedicalRepresentatives"
                                icon="user-tie">
                </x-cards.widget>
            </a>
        </div>
    ...
    {{-- Row 2: Tours, Pending Tour Approvals, Pending DCR Approvals, Pending Expense Approvals --}}
    @if (in_array('tours', user_modules()) && in_array('total_tours', $activeWidgets))
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="{{ route('tours.index') }}">
                <x-cards.widget :title="__('modules.dashboard.totalTours')" :value="$counts->totalTours"
                                icon="route">
                </x-cards.widget>
            </a>
        </div>
    ...
    @if (in_array('tours', user_modules()) && in_array('pending_tour_approvals', $activeWidgets))
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="{{ route('tours.index') . '?status=pending' }}">
                <x-cards.widget :title="__('modules.dashboard.pendingTourApprovals')" :value="$counts->pendingTourApprovals"
                                icon="clock">
                </x-cards.widget>
            </a>
        </div>
    ...
    @if (in_array('dcr_reports', user_modules()) && in_array('pending_dcr_approvals', $activeWidgets))
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="{{ route('dcr-management.index') . '?status=pending' }}">
                <x-cards.widget :title="__('modules.dashboard.pendingDcrApprovals')" :value="$counts->pendingDcrApprovals ?? 0"
                                icon="file-alt">
                </x-cards.widget>
            </a>
        </div>
    ...
    @if (in_array('expenses', user_modules()) && in_array('pending_expense_approvals', $activeWidgets))
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
            <a href="{{ route('expenses.index') . '?status=pending' }}">
                <x-cards.widget :title="__('modules.dashboard.pendingExpenseApprovals')" :value="$counts->pendingExpenseApprovals ?? 0"
                                icon="money-bill">
                </x-cards.widget>
            </a>
        </div>
    ...
    {{-- Row 3: Total CFA/Distributors, Employees, Today Attendance, Due Invoices --}}
    ...
    {{-- Row 4: Projects, Tasks, Tickets, Timelogs (if modules enabled) --}}

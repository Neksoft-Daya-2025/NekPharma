            ...
            <nav class="tabs">
                <ul class="-primary">
                    ...
                    @if (in_array('pharma_areas', user_modules()))
                        <li>
                            <x-tab :href="route('employees.show', $employee->id) . '?tab=territory-mapping'" :text="__('modules.employees.territoryMappingTitle')" ajax="false" class="territory-mapping" />
                        </li>
                    @endif
                    ...
                    @if ($showFullProfile && $employee->employeeDetail && $employee->employeeDetail->last_date)
                        <li>
                            <x-tab :href="route('employees.show', $employee->id) . '?tab=fnf'" :text="__('app.menu.fnfSettlement')" class="fnf" />
                        </li>
                    @endif
                </ul>
            </nav>

                        ...
                        <x-forms.select fieldId="user_id" :fieldLabel="'Select Employee'" fieldName="user_id" 
                            ...
                            @foreach($employees as $employee)
                                <x-user-option
                                    ...
                                    :employeeSelect="true"
                                    :optionExtraAttrs="[
                                        'data-last-date' => optional($employee->employeeDetail)->last_date ? optional($employee->employeeDetail)->last_date->format('Y-m-d') : '',
                                        'data-salary' => optional($employee->employeeDetail)->salary ?? 0,
                                    ]"
                                />
                            @endforeach
                        </x-forms.select>

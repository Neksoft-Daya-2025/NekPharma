                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-borderless f-13">
                            ...
                            <tr>
                                ...
                                <td class="text-right"><strong>{{ $fnfSettlement->employee->mobile ?? '-' }}</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><strong>{{ $fnfSettlement->employee->employeeDetail->department->team_name ?? '-' }}</strong></td>
                            </tr>
                            @if($fnfSettlement->employee->employeeDetail->reportingTo)
                            <tr>
                                <td class="text-muted">Reporting Manager:</td>
                                <td class="text-right"><strong>{{ $fnfSettlement->employee->employeeDetail->reportingTo->name }}</strong></td>
                            </tr>
                            @endif
                            @if($fnfSettlement->employee->employeeDetail->headquarter)
                            <tr>
                                <td class="text-muted">Headquarter:</td>
                                <td class="text-right"><strong>{{ $fnfSettlement->employee->employeeDetail->headquarter->name }}</strong></td>
                            </tr>
                            @endif
                            @if($fnfSettlement->employee->employeeDetail->area)
                            <tr>
                                <td class="text-muted">Area:</td>
                                <td class="text-right"><strong>{{ $fnfSettlement->employee->employeeDetail->area->name }}</strong></td>
                            </tr>
                            @endif
                            <tr>
                                <td class="text-muted">Joining Date:</td>
                                <td class="text-right"><strong>{{ $fnfSettlement->employee->employeeDetail->joining_date ? $fnfSettlement->employee->employeeDetail->joining_date->format(company()->date_format) : '-' }}</strong></td>
                            </tr>
                            @if($fnfSettlement->employee->employeeDetail->address)
                            <tr>
                                <td class="text-muted">Address:</td>
                                <td class="text-right"><strong class="f-11">{{ \Illuminate\Support\Str::limit($fnfSettlement->employee->employeeDetail->address, 30) }}</strong></td>
                            </tr>
                            @endif
                            <tr class="border-top">
                            ...
                            @php
                                $totalDays = $fnfSettlement->employee->employeeDetail->joining_date ? 
                                    $fnfSettlement->employee->employeeDetail->joining_date->diffInDays($fnfSettlement->last_working_day) : 0;
                        ...
                        @if($fnfSettlement->employee->employeeDetail->bank_account_number || $fnfSettlement->employee->employeeDetail->bank_name)
                        <div class="border-top pt-3 mt-3">
                            <h6 class="text-muted mb-2">Bank Details</h6>
                            <table class="table table-borderless f-12">
                                @if($fnfSettlement->employee->employeeDetail->bank_name)
                                <tr>
                                    <td class="text-muted">Bank:</td>
                                    <td class="text-right"><strong>{{ $fnfSettlement->employee->employeeDetail->bank_name }}</strong></td>
                                </tr>
                                @endif
                                @if($fnfSettlement->employee->employeeDetail->bank_account_number)
                                <tr>
                                    <td class="text-muted">Account No:</td>
                                    <td class="text-right"><strong>{{ $fnfSettlement->employee->employeeDetail->bank_account_number }}</strong></td>
                                </tr>
                                @endif
                                @if($fnfSettlement->employee->employeeDetail->ifsc_code)
                                <tr>
                                    <td class="text-muted">IFSC:</td>
                                    <td class="text-right"><strong>{{ $fnfSettlement->employee->employeeDetail->ifsc_code }}</strong></td>
                                </tr>
                                @endif
                            </table>
                        </div>
                ...
                <div class="card border-0 b-shadow-4 mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-sm f-13">
                            ...
                            <tr>
                                <td>EL Balance (Earned Leave) – {{ $fnfSettlement->leave_balance_days }} days</td>

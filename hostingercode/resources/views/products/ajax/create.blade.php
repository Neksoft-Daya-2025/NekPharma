                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.mrp')"
                                                fieldName="mrp" fieldId="mrp"
                                                :fieldPlaceholder="__('app.mrp')"
                                                fieldValue=""/>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.pts')"
                                                fieldName="pts" fieldId="pts"
                                                :fieldPlaceholder="__('app.pts')"
                                                fieldValue=""/>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.ptr')"
                                                fieldName="ptr" fieldId="ptr"
                                                :fieldPlaceholder="__('app.ptr')"
                                                fieldValue=""/>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.discount')"
                                                fieldName="discount" fieldId="discount"
                                                :fieldPlaceholder="__('app.discount')"
                                                fieldValue=""/>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <x-forms.label class="my-3" fieldId="discount_type" :fieldLabel="__('app.discountType')"></x-forms.label>
                                <select class="form-control select-picker" name="discount_type" id="discount_type">
                                    <option value="flat">@lang('app.flat')</option>

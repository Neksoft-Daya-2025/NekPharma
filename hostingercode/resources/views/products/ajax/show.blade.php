                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <x-cards.data-row :label="__('app.mrp')" :value="isset($product->mrp) && $product->mrp !== null ? currency_format($product->mrp, company()->currency_id) : '--'" />
                            <x-cards.data-row :label="__('app.pts')" :value="isset($product->pts) && $product->pts !== null ? currency_format($product->pts, company()->currency_id) : '--'" />
                            <x-cards.data-row :label="__('app.ptr')" :value="isset($product->ptr) && $product->ptr !== null ? currency_format($product->ptr, company()->currency_id) : '--'" />
                            <x-cards.data-row :label="__('app.discount')" :value="isset($product->discount) && $product->discount !== null ? currency_format($product->discount, company()->currency_id) . (isset($product->discount_type) && $product->discount_type === 'percentage' ? ' %' : '') : '--'" />
                            <x-cards.data-row :label="__('app.status')" :value="($product->status ?? 'active') === 'active' ? '<span class=\'badge badge-success\'>'.__('app.active').'</span>' : '<span class=\'badge badge-secondary\'>'.__('app.inactive').'</span>'" />

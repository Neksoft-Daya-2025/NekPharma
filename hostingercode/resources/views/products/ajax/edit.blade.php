                ...
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.mrp')"
                                    fieldName="mrp" fieldId="mrp" :fieldPlaceholder="__('app.mrp')"
                                    :fieldValue="$product->mrp ?? ''" />
                            </div>

                            <div class="col-md-4">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.pts')"
                                    fieldName="pts" fieldId="pts" :fieldPlaceholder="__('app.pts')"
                                    :fieldValue="$product->pts ?? ''" />
                            </div>

                            <div class="col-md-4">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.ptr')"
                                    fieldName="ptr" fieldId="ptr" :fieldPlaceholder="__('app.ptr')"
                                    :fieldValue="$product->ptr ?? ''" />
                            </div>

                            <div class="col-md-4">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.discount')"
                                    fieldName="discount" fieldId="discount" :fieldPlaceholder="__('app.discount')"
                                    :fieldValue="$product->discount ?? ''" />
                            </div>

                            <div class="col-md-4">
                                <x-forms.label class="my-3" fieldId="discount_type" :fieldLabel="__('app.discountType')"></x-forms.label>
                                <select class="form-control select-picker height-35" name="discount_type" id="discount_type">
                                    <option value="flat" @if(($product->discount_type ?? 'flat') == 'flat') selected @endif>@lang('app.flat')</option>
                                    <option value="percentage" @if(($product->discount_type ?? '') == 'percentage') selected @endif>@lang('app.percentage')</option>
                                </select>
                            </div>

                            <div class="col-md-4">
                                <x-forms.label class="my-3" fieldId="status" :fieldLabel="__('app.status')"></x-forms.label>
                                <select class="form-control select-picker height-35" name="status" id="status">
                                    <option value="active" @if(($product->status ?? 'active') == 'active') selected @endif>@lang('app.active')</option>
                                    <option value="inactive" @if(($product->status ?? '') == 'inactive') selected @endif>@lang('app.inactive')</option>
                                </select>
                            </div>

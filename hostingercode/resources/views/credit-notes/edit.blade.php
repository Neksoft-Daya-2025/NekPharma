    ...
    <div class="content-wrapper">
        ...
        <div class="bg-white rounded b-shadow-4 create-inv">
            ...
            <x-form class="c-inv-form" id="saveInvoiceForm">
                ...
                <!-- CREDIT NOTE TYPE START -->
                <div class="row px-lg-4 px-md-4 px-3 py-2">
                    <div class="col-md-4">
                        <div class="form-group mb-0">
                            <label class="f-14 text-dark-grey mb-12" for="credit_note_type">Credit Note Type</label>
                            <select class="form-control select-picker" name="credit_note_type" id="credit_note_type">
                                <option value="saleable" {{ ($creditNote->credit_note_type ?? 'saleable') === 'saleable' ? 'selected' : '' }}>Saleable</option>
                                <option value="non_saleable" {{ ($creditNote->credit_note_type ?? '') === 'non_saleable' ? 'selected' : '' }}>Non-Saleable</option>
                            </select>
                        </div>
                    </div>
                </div>

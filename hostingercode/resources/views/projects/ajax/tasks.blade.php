        ...
        <div class="d-flex justify-content-between">
            <form action="" class="flex-grow-1 " id="filter-form">
                <div class="d-flex mt-3">
                    ...
                    <div class="select-box py-2 px-0 mr-3">
                        ...
                        <select class="form-control select-picker" id="milestone_id" data-live-search="true" data-container="body" data-size="8" data-html="true">
                            <option value="all">@lang('app.all')</option>
            ...
            <x-datatable.actions class="mt-5">
                ...
                <div class="select-milestone mr-3 d-none quick-action-field2 change-milestone-action" id="change-milestone-action">
                    <select name="milestone" class="form-control select-picker" data-html="true">
                        @foreach ($project->milestones as $milestone)

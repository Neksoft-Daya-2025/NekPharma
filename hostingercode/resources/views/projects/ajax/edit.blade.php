                        ...
                        <div class="form-group my-3">
                            ...
                            <x-forms.input-group>
                                <select class="select-picker form-control" multiple name="project_labels[]"
                                    id="project_labels" data-live-search="true" data-size="8" data-html="true">
                            ...
                            @endphp
                                ...
                                <x-forms.input-group>
                                    <select class="form-control multiple-users" multiple name="member_id[]"
                                        id="selectEmployee" data-live-search="true" data-size="8" data-html="true">
                                        @foreach ($employeesToShow as $item)
                                            ...
                                            @if ($item->status === 'active' || $isMember)
                                                <x-user-option :user="$item" :employeeSelect="true" :selected="$selected" :pill="true"/>
                                            @endif
                                        @endforeach
                                    </select>
                    ...
                    @if ($editPermission == 'all')
                        <div class="col-lg-3 col-md-6">
                            ...
                            <x-forms.select fieldId="added_by" :fieldLabel="__('app.added').' '.__('app.by')"
                                ...
                                <option value="">--</option>
                                @foreach ($employeesToShow as $item)
                                    <x-user-option :user="$item" :employeeSelect="true" :selected="$project->added_by == $item->id" />
                                @endforeach
                            </x-forms.select>
                        </div>
                    @endif

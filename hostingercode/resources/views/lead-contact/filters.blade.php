<x-filters.filter-box>
    ...
    <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
        ...
        <div class="select-status">
            <select class="form-control select-picker" name="type" id="type" data-html="true">
    ...
    <x-filters.more-filter-box>
        ...
        <div class="more-filter-items">
            ...
            <div class="select-filter mb-4">
                <div class="select-others">
                    <select class="form-control select-picker" id="filter_source_id" data-live-search="true" data-container="body" data-size="8" data-html="true">
        ...
        <div class="more-filter-items">
            ...
            <div class="select-filter mb-4">
                <div class="select-others">
                    <select class="form-control select-picker" id="filter_owner_id" data-live-search="true" data-container="body" data-size="8" data-html="true">
                        <option value="all">@lang('app.all')</option>
        ...
        <div class="more-filter-items">
            ...
            <div class="select-filter mb-4">
                <div class="select-others">
                <select class="form-control select-picker" id="filter_addedBy" data-live-search="true" data-container="body" data-size="8" data-html="true">
                    <option value="all">@lang('app.all')</option>
                    @foreach ($employees as $item)
                        <x-user-option :user="$item" :employeeSelect="true"  />
                    @endforeach

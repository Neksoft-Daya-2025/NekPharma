<div class="col-sm-12">
    ...
    <div class="w-100 border-top-grey justify-content-start px-4 py-3 bg-white rounded d-none" id="afterProcessing">
        <x-forms.link-primary :link="route('chemists.index')">@lang('app.back') @lang('Chemists')</x-forms.link-primary>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function getProgress(batchId) {
        ...
        var url = "{{ route('import.process.progress', ['ChemistImport', ':batchId']) }}";
    ...
    function getQueueException() {
        var url = "{{ route('import.process.exception', 'ChemistImport') }}";

        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <x-forms.text fieldId="msl_number" fieldLabel="MSL Number" fieldName="msl_number"
                    fieldPlaceholder="Enter MSL Number" :fieldValue="$chemist->msl_number">
                </x-forms.text>
            </div>

            <div class="col-md-3">
                <x-forms.number fieldId="latitude" fieldLabel="Latitude (GPS)" fieldName="latitude"
                    fieldPlaceholder="e.g. 28.6139" :fieldValue="$chemist->latitude ?? null">
                </x-forms.number>
            </div>
            <div class="col-md-3">
                <x-forms.number fieldId="longitude" fieldLabel="Longitude (GPS)" fieldName="longitude"
                    fieldPlaceholder="e.g. 77.2090" :fieldValue="$chemist->longitude ?? null">
                </x-forms.number>
            </div>
        </div>
    </x-form>

                            ...
                            <div class="col-md-4">
                                <x-forms.select fieldId="country" :fieldLabel="__('app.country')" fieldName="country"
                                    ...
                                    <option data-tokens="{{ $item->iso3 }}" data-phonecode = "{{$item->phonecode}}"
                                        ...
                                        @selected((isset($lead) && $item->nicename == $lead->country) || (!isset($lead) && $item->nicename == 'India'))
                    ...
                    <div class="col-md-3">
                        <div class="form-group my-3">
                            <label class="f-14 text-dark-grey mb-12 w-100 mt-3"
                                for="usr">Login</label>
                            <div class="d-flex">
                                <x-forms.radio fieldId="login-yes" :fieldLabel="__('app.yes')" fieldValue="enable"
                                    fieldName="login" checked="true">
                                </x-forms.radio>
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-3">
                        <x-forms.text class="mb-3 mt-3 mt-lg-0 mt-md-0" fieldId="dl_number"
                            fieldLabel="DL Number" fieldName="dl_number"

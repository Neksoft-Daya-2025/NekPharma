                    ...
                    <div class="col-md-6 col-lg-6">
                        ...
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="category_id" id="task_category_id"
                                data-live-search="true" data-size="8" data-html="true">
                                <option value="">--</option>
                                ...
                                <select class="form-control multiple-users" multiple name="user_id[]"
                                    ...
                                    @foreach ($employees as $employee)
                                        ...
                                        @if ($employee->status === 'active' || $isMember)
                                            <x-user-option :user="$employee" :employeeSelect="true" :pill=true :selected="$selected"/>
                                        @endif
                                    @endforeach
                                </select>
                                ...
                                <div class="form-group my-3">
                                    ...
                                    <x-forms.input-group>
                                        <select class="select-picker form-control" multiple name="task_labels[]"
                                            id="task_labels" data-live-search="true" data-size="8" data-html="true">
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-3">
                                    ...
                                    <x-forms.input-group>
                                        ...
                                        <x-slot name="append">
                                            <select name="repeat_type" class="select-picker form-control" data-html="true">

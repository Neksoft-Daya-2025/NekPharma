    ...
    <x-filters.filter-box>
        ...
        <div class="select-box d-flex  py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            ...
            <div class="select-status">
                <select class="form-control select-picker"  id="assignedTo" data-live-search="true" data-size="8" data-html="true">
        ...
        {{-- <div class="select-box d-flex  py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            ...
            <div class="select-status">
                <select class="form-control select-picker"  id="project_id" data-live-search="true" data-size="8" data-html="true">
                    <option value="all">@lang('app.all')</option>
        ...
        <div class="d-flex flex-column">
            ...
            <div class="d-grid d-lg-flex d-md-flex action-bar align-items-center mt-3 ">
                ...
                <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                    ...
                    <a href="{{ route('employee-wise-task-report') }}" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"

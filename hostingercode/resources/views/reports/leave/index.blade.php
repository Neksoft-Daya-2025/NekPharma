...
@push('styles')
<style media="print">
    body .sidebar, body .main-header, body .content-wrapper > .action-bar,
    body .filter-box, body .btn-group, body .dataTables_length, body .dataTables_filter,
    body .dataTables_wrapper .dt-buttons, body .breadcrumb, body .page-header,
    body .no-print { display: none !important; }
    body .content-wrapper { padding: 0 !important; }
    body .w-tables { box-shadow: none !important; border: 1px solid #ddd !important; }
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3 no-print" role="group">
                ...
                <button type="button" class="btn btn-secondary f-14" onclick="window.print();" data-toggle="tooltip" title="@lang('app.print')">

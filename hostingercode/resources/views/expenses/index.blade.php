    ...
    <x-filters.filter-box>
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            ...
            <div class="select-status">
                <select class="form-control select-picker" id="filter-status" data-html="true">
        ...
        <x-filters.more-filter-box>
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="employee2" data-live-search="true" data-container="body" data-size="8" data-html="true">
                                <option value="all">@lang('app.all')</option>
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" name="project_id" id="project_id2" data-container="body" data-live-search="true" data-size="8" data-html="true">
                            <option value="all">@lang('app.all')</option>
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" name="category_id" id="category_id" data-container="body" data-live-search="true" data-size="8" data-html="true">
                            <option value="all">@lang('app.all')</option>
        ...
        <div class="d-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addExpensesPermission == 'all' || $addExpensesPermission == 'added')
                    <x-forms.link-primary :link="route('expenses.create')" class="mr-3 float-left"
                        icon="plus">
                ...
                @if ($addExpensesPermission == 'all' || $addExpensesPermission == 'added')
                    ...
                    <x-forms.link-secondary :link="route('expenses.import.pharma')" class="mr-3 float-left openRightModal"
                                            icon="file-excel">
                        @lang('app.importPharmaExpenseStatement')
                    </x-forms.link-secondary>
                @endif
            </div>
                    ...
                    $.easyAjax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status == "success") {
                                ...
                                // Reset action buttons and deselect all
                                resetActionButtons();
                                deSelectAll();
                            } else {

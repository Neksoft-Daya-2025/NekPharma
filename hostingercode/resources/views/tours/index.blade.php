    ...
    <div class="d-flex flex-column w-100 mt-4">
        <form action="{{ route('tours.store') }}" method="POST" id="tour-plan-form">
            ...
            <div class="row mb-4 align-items-start">
                @if(user()->hasRole('admin') || ($employees->isNotEmpty() && !user()->hasRole('admin')))
                    <div class="col-md-3">
...
<!--================================================================================================-->
                <div class="col-md-{{ user()->hasRole('admin') ? '3' : '6' }}">
                    ...
                    <div class="d-flex flex-wrap align-items-center" style="min-height: 35px;">
                        ...
                        @if(user()->hasRole('admin') && !empty($selectedEmployeeId) && $selectedEmployeeId != 'all')
                            @php
            ...
            @if(user()->hasRole('admin') && isset($lockedMonths) && $lockedMonths->isNotEmpty())
            <div class="row mb-3">
                <div class="col-12">

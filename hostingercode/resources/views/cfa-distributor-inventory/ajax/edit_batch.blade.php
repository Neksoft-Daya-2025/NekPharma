        ...
        <x-form id="save-batch-form" method="PUT">
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <x-forms.number fieldId="available_quantity" :fieldLabel="__('app.availableQuantity')" fieldName="available_quantity"
                            fieldRequired="true" :fieldValue="$batch->available_quantity" />
                    </div>
                    <div class="col-md-6 col-lg-4">
...
<script>
    $(function() {
        ...
        $('#save-batch-btn').click(function() {
            var url = "{{ route('cfa-distributor-inventory.batches.update', $batch->id) }}";

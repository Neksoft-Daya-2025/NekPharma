    ...
    <x-filters.filter-box>
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            ...
            <div class="select-status">
                <select class="form-control select-picker" name="status" id="ticket-status" data-html="true">
        ...
        <x-filters.more-filter-box>
                                    ...
                                    @foreach ($groups as $group)
                                        <optgroup label="{{ $group->group_name }}">
                                            @foreach ($group->enabledAgents as $agent)
                                                @if($agent->user)
                                                    {{-- <x-user-option :user="$agent->user" :employeeSelect="true" :selected="(request('agent') == $agent->user->id) || (request('agent') == 'me' && $agent->user->id == user()->id)" /> --}}
                                                        <x-user-option :user="$agent->user" :employeeSelect="true"  />
                                                @endif
                                            @endforeach
                                        </optgroup>
                                    @endforeach
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="channel_id" data-container="body" data-html="true">
                            <option value="all">@lang('app.all')</option>
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" multiple="multiple" name="tagId[]" id="tag_id"
                            data-live-search="true" data-size="8" data-container="body" data-html="true">

...
@push('scripts')
    ...
    <script>
        ...
        // Ensure SEARCH_KEYWORD is available globally
        if (typeof window.SEARCH_KEYWORD === 'undefined') {
        ...
        if (typeof window.daterangeLocale === 'undefined') {
            console.warn('daterangeLocale is not defined');
        }
        if (typeof window.daterangeConfig === 'undefined') {
            console.warn('daterangeConfig is not defined');
        }

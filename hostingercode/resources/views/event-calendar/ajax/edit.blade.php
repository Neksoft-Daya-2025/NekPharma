                            ...
                            @else
                                ...
                                <x-forms.input-group>
                                    ...
                                    <select class="form-control multiple-users" multiple name="user_id[]"
                                        id="selectAssignee" data-live-search="true" data-size="8" data-html="true">
                                        @foreach ($employeesToShow as $emp)
                                            <x-user-option :user="$emp" :employeeSelect="true" :pill=true :selected="in_array($emp->id, $attendeeArray)"/>
                                        @endforeach
                                    </select>
                                </x-forms.input-group>
                            @endif
                    ...
                    <div class="col-md-6">
                        <div class="form-group my-3">
                            ...
                            @else
                                ...
                                <x-forms.input-group>
                                    <select class="form-control multiple-users" multiple name="user_id[]"
                                        id="selectAssignee2" data-live-search="true" data-size="8" data-html="true">
                            ...
                            @else
                                ...
                                <x-forms.input-group>
                                    ...
                                    <select class="form-control multiple-users" name="host"
                                        id="selectHost" data-live-search="true" data-size="8" data-html="true">
                                        <option value="">--</option>
                                        @foreach ($employeesToShow as $item)
                                            <x-user-option :user="$item" :employeeSelect="true" :pill=true :selected="($item->id == $event->host)"/>
                                        @endforeach
                                    </select>
                                </x-forms.input-group>
                            @endif
                        ...
                        <div class="form-group c-inv-select mb-4 my-3">
                            ...
                            <div class="select-others height-35 rounded">
                                <select class="form-control select-picker" data-live-search="true" data-size="8"
                                    name="status" id="status" data-html="true">

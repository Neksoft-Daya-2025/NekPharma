...
<div class="table-responsive">
    <x-table class="table-bordered mt-3 table-hover" headType="thead-light">
        <x-slot name="thead">
            ...
            <th class="px-2 text-nowrap" style="vertical-align: middle;">@lang('modules.employees.employeeId')</th>
            <th class="px-2" style="vertical-align: middle;">@lang('modules.employees.territoryMappingHeadquarter')</th>
        ...
        @foreach ($employeeAttendence as $key => $attendance)
            ...
            <tr>
                ...
                @php
                    $rowMeta = $employeeRowMeta[$key] ?? ['employee_id' => '', 'headquarter' => ''];
                @endphp
                <td class="px-2 f-11 text-nowrap align-middle">{{ $rowMeta['employee_id'] !== '' ? $rowMeta['employee_id'] : '—' }}</td>
                <td class="px-2 f-11 align-middle mw-250">{{ $rowMeta['headquarter'] !== '' ? $rowMeta['headquarter'] : __('modules.employees.territoryMappingNone') }}</td>

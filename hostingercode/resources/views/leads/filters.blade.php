<x-filters.filter-box>
    ...
    <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
        ...
        <div class="select-status">
            <select class="form-control select-picker pipelineFilter" name="pipeline" id="pipeline" data-html="true">
    ...
    <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
        ...
        <div class="select-status">
            <select class="form-control select-picker categoryFilter" name="category" id="category" data-html="true">
    ...
    <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
        ...
        <div class="select-status">
            <select class="form-control select-picker productFilter" name="product" id="product" data-html="true">
                <option value="all">@lang('app.all')</option>
            ...
            <div class="more-filter-items  ">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="filter_status_id" data-live-search="true" data-container="body" data-size="8" data-html="true">
                            <option value="all">@lang('app.all')</option>
                    ...
                    <div class="select-others">
                        <select class="form-control select-picker" name="deal_watcher_agent_id" id="deal_watcher_agent_id" data-live-search="true"
                            ...
                            @foreach ($dealWatcher as $agent)
                                <x-user-option :user="$agent" :employeeSelect="true" />
                            @endforeach
                        </select>
                    </div>
                </div>

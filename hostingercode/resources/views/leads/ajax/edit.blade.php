                    ...
                    @if(in_array('products', user_modules()) || in_array('purchase', user_modules()))
                        <div class="col-lg-4 mt-3">
                            <div class="form-group">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" data-live-search="true" data-size="8"  name="product_id[]" multiple  id="add-products" title="{{ __('app.menu.selectProduct') }}" data-html="true">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <x-forms.select fieldId="deal_watcher" :fieldLabel="__('app.dealWatcher')"
                            ...
                            @foreach ($employees as $item)
                                <x-user-option :user="$item" :employeeSelect="true" :selected="($deal->deal_watcher == $item->id)"/>
                            @endforeach
                        </x-forms.select>
                    </div>

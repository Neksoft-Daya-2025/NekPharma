                            ...
                            <select class="form-control select-picker" name="leave_type_id" id="leave_type_id"
                                ...
                                @foreach ($leaveQuotas as $leaveQuota)
                                    ...
                                    && $leaveQuota->leaveType->deleted_at == null
                                        ...
                                        <option @selected($leave->leave_type_id == $leaveQuota->leaveType->id) value="{{ $leaveQuota->leaveType->id }}">{{ $leaveQuota->leaveType->type_name }} ({{ rtrim(rtrim(number_format((float) $leaveQuota->leaves_remaining, 1, '.', ''), '0'), '.') }})</option>
                                    @endif
                                @endforeach
                            </select>

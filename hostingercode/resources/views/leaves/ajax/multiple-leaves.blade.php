            ...
            <div class="card-header bg-white  border-bottom-grey  justify-content-between p-20">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xs-8 text-right">
                        ...
                        @if (($pendingCountLeave > 0 && $isReportee) || ($managerApprovedCount > 0 && $approveRejectPermission == 'all'))
                        ...
                        @endif
                        @if (($pendingCountLeave > 0 || $managerApprovedCount > 0) && ($isReportee || $approveRejectPermission == 'all'))

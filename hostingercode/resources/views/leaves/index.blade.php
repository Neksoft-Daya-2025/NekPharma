...
$viewLeaveReportPermission = user()->permission('view_leave_report');
@endphp
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" name="employee_id" id="employee_id"
                            data-live-search="true" data-container="body" data-size="8" data-html="true">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" name="leave_type" id="leave_type" data-live-search="true"
                            data-container="body" data-size="8" data-html="true">
                            <option value="all">@lang('app.all')</option>
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        {{-- Leave Management flow (SRS 3.1.2) --}}
        <div class="alert alert-info border-0 mb-3 py-3 px-4 d-flex align-items-center flex-wrap" style="background: linear-gradient(135deg, #e8f5e9 0%, #f1f8e9 100%); border-left: 4px solid #2e7d32;">
            <div class="flex-grow-1 mr-4 mb-2 mb-md-0" style="min-width: 0;">
                <strong class="d-block f-14 mb-1"><i class="fa fa-calendar-check-o mr-1"></i> @lang('modules.leaves.leaveManagementFlow')</strong>
                <span class="f-13 text-dark-grey">@lang('modules.leaves.leaveManagementDescription')</span>
            </div>
            <div class="d-flex flex-wrap align-items-center mt-2 mt-md-0" style="gap: 1rem;">
                @if ($addLeavePermission == 'all' || $addLeavePermission == 'added' || $addLeavePermission == 'owned' || $addLeavePermission == 'both')
                    <a href="{{ route('leaves.create') }}" class="btn btn-primary openRightModal">
                        <i class="fa fa-plus mr-1"></i> @lang('modules.leaves.applyLeave')
                    </a>
                @endif
                @if (in_array($viewLeaveReportPermission, ['all', 'added', 'owned', 'both']))
                    <a href="{{ route('leave-report.employee-leave-report') }}" class="btn btn-outline-secondary">
                        <i class="fa fa-file-text-o mr-1"></i> @lang('modules.leaves.viewLeaveReport')
                    </a>
                @endif
            </div>
        </div>

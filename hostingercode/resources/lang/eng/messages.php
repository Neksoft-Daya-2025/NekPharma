...
return array(
    ...
    'moduleDisabledEmployeeHint' => 'This module is not turned on for employees. Open Settings, then Module Settings, enable it for the Employee role, and return here to edit permissions.',
    'permissionsMoreExpandHint' => 'Expand to set additional permissions (e.g. CFA stockists, stocks, invoices). If the module is off for employees, fields stay read-only until you enable it in Module Settings.',
    ...
    'attendanceFieldEmployeeNoManual' => 'Field employees\' attendance is marked only when DCR is closed for the day. Manual clock-in/out or add attendance is not allowed.',
    'attendanceMonthNotFinalised' => 'Please finalise attendance for the selected month before generating payroll.',
    'attendanceAlreadyFinalised' => 'Attendance for this month is already finalised.',
    'attendanceFinalisedSuccess' => 'Attendance for the selected month has been finalised. You can now generate payroll.',
    ...
    'pharmaExpenseImportMonthLocked' => 'This month is already submitted or approved. Import is not allowed.',
    'pharmaExpenseImportSelfOnly' => 'You can only import expenses for your own account.',
    'pharmaExpenseImportDateNotInSelectedMonth' => 'Row date is not in the selected expense month.',
    'pharmaExpenseImportDuplicateDay' => 'An expense already exists for this date (not rejected). Remove the duplicate row or delete the existing expense first.',
    ...
    'leave' => array(
        ...
        'lwpConfigurationNote' => 'LWP applies when: (1) Employee quota is exhausted and they take additional leave - set "Over-quota as LWP" below, or (2) Managers/Admin/HR manually add LWP - create the LWP leave type below.',
        'overQuotaAsLwpNote' => 'Sets all leave types to treat over-quota leaves as LWP (unpaid). When employees take leave beyond their quota, it will be marked as Leave Without Pay.',
        'lwpTypeConfigured' => 'LWP leave type is configured. Managers, Admin and HR can add LWP manually when adding leave on behalf of employees.',
        'lwpTypeCreateNote' => 'Creates a "Leave Without Pay (LWP)" leave type for manual use. Managers, Admin and HR can select this when adding leave on behalf of employees.',
        'lwpTypeAlreadyExists' => 'An LWP leave type already exists.',
        'lwpTypeCreated' => 'LWP leave type created successfully.',
    ),

...
use App\Http\Controllers\EmployeeFnfSettlementController;
...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::post('fnf-settlements/{id}/mark-payment-complete', [EmployeeFnfSettlementController::class, 'markPaymentComplete'])->name('fnf-settlements.mark-payment-complete');
    ...
    Route::get('invoices/products-consolidated', [InvoiceController::class, 'getConsolidatedProducts'])->name('invoices.products-consolidated');
    Route::get('invoices/product-batches', [InvoiceController::class, 'getProductBatches'])->name('invoices.product-batches');
    Route::get('invoices/get-batch-details', [InvoiceController::class, 'getBatchDetails'])->name('invoices.get_batch_details');
    ...
    Route::prefix('pharma-areas')->name('pharma-areas.')->group(function () {
        // Headquarters
        Route::get('/headquarters', [PharmaAreaController::class, 'headquarters'])->name('headquarters');

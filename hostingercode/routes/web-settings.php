...
Route::group(['middleware' => 'auth', 'prefix' => 'account/settings'], function () {
    ...
    Route::post('app-settings/reset-cache', [AppSettingController::class, 'resetCache'])->name('app-settings.reset_cache');
    ...
    Route::post('leaves-settings/apply-over-quota-lwp', [LeaveSettingController::class, 'applyOverQuotaAsLwp'])->name('leaves-settings.apply-over-quota-lwp');
    Route::post('leaves-settings/create-lwp-type', [LeaveSettingController::class, 'createLwpLeaveType'])->name('leaves-settings.create-lwp-type');
    ...
    Route::get('software-health', [SystemHealthController::class, 'index'])->name('software-health.index');
...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::post('update-settings/install', [UpdateAppController::class, 'install'])->name('update-settings.install');
    Route::get('update-settings/install', [UpdateAppController::class, 'install'])->name('update-settings.install.get');

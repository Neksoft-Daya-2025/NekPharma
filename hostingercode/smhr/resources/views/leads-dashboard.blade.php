                    ...
                    <div class="card flex-fill">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                <h5>Lost Leads </h5>
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="btn btn-white border-0 dropdown-toggle dropdown-sm btn-sm d-inline-flex align-items-center" data-bs-toggle="dropdown" aria-expanded="false">
                                        Sales Pipeline
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end p-3">
                                        <li>
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <div class="d-flex align-items-center"><a href="#" class="btn btn-light btn-icon btn-sm d-flex justify-content-center align-items-center border-0 p-2"><i class="ti ti-phone-x fs-16"></i></a>
                                </div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="#" class="btn btn-light btn-icon btn-sm d-flex justify-content-center align-items-center border-0 p-2"><i class="ti ti-brand-hipchat fs-16"></i></a>
                                </div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                    ...
                    <div class="card flex-fill">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                ...
                                <div>
                                    <a href="{{url('activity')}}" class="btn btn-light btn-md">View All</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-7 d-flex">
                    <div class="card flex-fill">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                            ...
                            <div class="d-flex align-items-center">
                                <div>
                                    <a href="{{url('leads')}}" class="btn btn-light btn-md">View All</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium"><a href="{{url('company-details')}}">BrightWave</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium"><a href="{{url('company-details')}}">Stellar</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium"><a href="{{url('company-details')}}">Quantum</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium"><a href="{{url('company-details')}}">EcoVision</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium"><a href="{{url('company-details')}}">Aurora</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>

<?php $page = 'layout-horizontal-fullwidth'; ?>
            ...
            <div class="card border-0">
                <div class="card-body d-flex align-items-center justify-content-between flex-wrap pb-1">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-1">
                        <a href="#" class="btn btn-white me-2 mb-2" data-bs-toggle="modal" data-bs-target="#add_project"><i class="ti ti-calendar-cog me-1"></i>Add Schedule</a>
                        <a href="#" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#add_leaves"><i class="ti ti-square-rounded-plus me-1"></i>Add Requests</a>
                    </div>
                </div>
            </div>
            <!-- /Welcome Wrap -->
                ...
                <div class="col-xxl-4 d-flex">
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row gx-0">
                                    <div class="col-6">
                                        <div class="p-2 flex-fill border-end border-bottom">
                                            <p class="fs-13 mb-2"><i class="ti ti-square-rounded-filled text-primary fs-12 me-2"></i>Fulltime <span class="text-gray-9">(48%)</span></p>
                                            <h2 class="fs-40 fw-bold">112</h2>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="p-2 flex-fill border-bottom text-end">
                                            <p class="fs-13 mb-2"><i class="ti ti-square-rounded0filled me-2 text-secondary fs-12"></i>Contract <span class="text-gray-9">(20%)</span></p>
                                            <h2 class="fs-40 fw-bold">112</h2>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="p-2 flex-fill border-end">
                                            <p class="fs-13 mb-2"><i class="ti ti-square-rounded-filled me-2 text-danger fs-12"></i>Probation <span class="text-gray-9">(22%)</span></p>
                                            <h2 class="fs-40 fw-bold">12</h2>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="p-2 flex-fill text-end">
                                            <p class="fs-13 mb-2"><i class="ti ti-square-rounded-filled text-pink me-2 fs-12"></i>WFH <span class="text-gray-9">(20%)</span></p>
                            ...
                            <div class="p-2 d-flex align-items-center justify-content-between border border-primary bg-primary-100 br-5 mb-4 perfomer-card">
                ...
                <div class="col-xxl-4 col-xl-6 d-flex">
                    <div class="card flex-fill">
                        <div class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap gap-2">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle btn btn-white btn-md d-inline-flex align-items-center border-0 fs-13 me-2" data-bs-toggle="dropdown">
                                        All Departments
                                    </a>
                                    <ul class="dropdown-menu  dropdown-menu-end p-3">
                                        <li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3 p-2 border border-dashed br-5">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <h6 class="fs-14 fw-medium text-truncate">Anthony Lewis <span class="fs-10 fw-medium d-inline-flex align-items-center badge badge-danger"><i class="ti ti-clock-hour-11 me-1"></i>30 Min</span></h6>
                                        <p class="fs-13">Marketing Head</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="link-default me-2"><i class="ti ti-clock-share"></i></a>
                                    <span class="fs-10 fw-medium d-inline-flex align-items-center badge badge-success"><i class="ti ti-circle-filled fs-5 me-1"></i>08:35</span>
                                </div>
                            </div>
                ...
                <div class="col-xl-7 d-flex">
                    <div class="card flex-fill">
                        <div class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="dropdown mb-2">
                                    <a href="javascript:void(0);" class="dropdown-toggle dropdown-sm btn btn-white border-0 btn-sm d-inline-flex align-items-center fs-13 me-2" data-bs-toggle="dropdown">
                                        All Departments
                                    </a>
                                    <ul class="dropdown-menu  dropdown-menu-end p-3">
                                        <li>
                        ...
                        <div class="card-body pb-0">
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                <div class="d-flex align-items-center mb-1">
                                    <p class="fs-13 text-gray-9 me-3 mb-0"><i class="ti ti-square-rounded-filled me-2 text-primary"></i>Income</p>
                ...
                <div class="col-xl-5 d-flex">
                    <div class="card flex-fill">
                        <div class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="dropdown mb-2">
                                    <a href="javascript:void(0);" class="dropdown-toggle dropdown-sm btn btn-white btn-sm d-inline-flex align-items-center fs-13 me-2 border-0" data-bs-toggle="dropdown">
                                        Invoices
                                    </a>
                                    <ul class="dropdown-menu  dropdown-menu-end p-3">
                                        <li>
                        ...
                        <div class="card-body">
                            <div class="bg-light p-3 br-5 mb-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top mt-2 pt-3">
                                    ...
                                    <a href="#" class="btn btn-white">Join Meeting</a>
                                </div>
                            </div>
                        ...
                        <div class="card-body pb-1">
                            ...
                            <div class="p-2 border border-dashed rounded mb-3 birthday-card active">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2 overflow-hidden">
                                            <h6 class="fs-medium "><a href="#">Andrew Jermia </a></h6>
                                            <p class="fs-13">IOS Developer</p>
                                        </div>
                                    </div>
                                    <a href="javascript:void(0);" class="btn btn-sm btn-white flex-shrink-0 border-0"><i class="ti ti-cake me-1"></i>Send</a>
                                </div>
                            </div>
                            ...
                            <div class="p-2 border border-dashed rounded mb-3 birthday-card">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-sm btn-white flex-shrink-0"><i class="ti ti-cake me-1"></i>Send</a>
                                </div>
                            </div>
                            <div class="p-2 border border-dashed rounded mb-3 birthday-card">
                                <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="p-2 border border-dashed rounded mb-3 birthday-card">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2 overflow-hidden">
                                            <h6 class="fs-medium "><a href="#"> Doglas Martini </a></h6>
                                            <p class="fs-13">.Net Developer</p>
                                        </div>
                                    </div>
                                    <a href="javascript:void(0);" class="btn btn-sm flex-shrink-0 btn-white"><i class="ti ti-cake me-1"></i>Send</a>
                                </div>
                            </div>
                        </div>
                    </div>

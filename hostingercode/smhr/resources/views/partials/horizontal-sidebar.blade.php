		...
		<div class="sidebar-menu">
			<div class="main-menu">
				<ul class="nav-menu">
					...
					<li class="submenu">
						<a href="#" class="{{ Request::is('layout-horizontal', 'layout-detached', 'layout-modern', 'layout-two-column', 'layout-hovered', 'layout-box', 'layout-horizontal-single', 'layout-horizontal-box', 'layout-horizontal-overlay', 'layout-horizontal-sidemenu', 'layout-vertical-transparent', 'layout-without-header', 'layout-rtl', 'layout-dark') ? 'active subdrop' : '' }}">
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a href="{{url('task-report')}}" class="{{ Request::is('task-repor') ? 'active' : '' }}">Task Report</a></li>
					...
					<li class="submenu">
						<a href="#" class="{{ Request::is('starter', 'profile', 'gallery', 'search-result', 'timeline', 'pricing', 'coming-soon', 'under-maintenance', 'under-construction', 'api-keys', 'privacy-policy', 'terms-condition') ? 'active subdrop' : '' }}">
									...
									<li class="submenu">
										...
										<ul>
											...
											<li class="submenu submenu-two">
												...
												<ul>
													<li>
														<a href="{{url('form-horizontal')}}" class="{{ Request::is('form-fileupload') ? 'active' : '' }}">Horizontal Form</a>
													</li>
													<li>
														<a href="{{url('form-vertical')}}" class="{{ Request::is('form-fileupload') ? 'active' : '' }}">Vertical Form</a>
													</li>
													<li>
														<a href="{{url('form-floating-labels')}}" class="{{ Request::is('form-fileupload') ? 'active' : '' }}">Floating Labels</a>
													</li>
												</ul>
											</li>
											<li>
												<a href="{{url('form-validation')}}" class="{{ Request::is('form-fileupload') ? 'active' : '' }}">Form Validation</a>
											</li>
											<li>
												<a href="{{url('form-select2')}}" class="{{ Request::is('form-fileupload') ? 'active' : '' }}">Select2</a>
											</li>
											<li>
												<a href="{{url('form-wizard')}}" class="{{ Request::is('form-fileupload') ? 'active' : '' }}">Form Wizard</a>
											</li>
											<li>
												<a href="{{url('form-pickers')}}" class="{{ Request::is('form-fileupload') ? 'active' : '' }}">Form Pickers</a>
											</li>

			...
			<div class="twocol-mini">
				...
				<div class="sidebar-left slimscroll">
					<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist" aria-orientation="vertical">
						<a href="#" class="nav-link {{ Request::is('index', '/', 'employee-dashboard', 'deals-dashboard', 'leads-dashboard', 'hr-dashboard', 'payroll-dashboard', 'recruitment-dashboard', 'attendance-dashboard', 'finance-dashboard', 'it-admin-dashboard', 'asset-dashboard', 'help-desk-dashboard') ? 'active ' : '' }}" title="Dashboard" data-bs-toggle="tab" data-bs-target="#dashboard">
							<i class="ti ti-smart-home"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('chat', 'call', 'voice-call', 'video-call', 'outgoing-call', 'incoming-call', 'call-history', 'calendar', 'email', 'email-reply', 'todo', 'todo-list', 'notes', 'social-feed', 'file-manager', 'kanban-view', 'invoices', 'add-invoices', 'edit-invoices', 'invoice-details') ? 'active' : '' }}" title="Apps" data-bs-toggle="tab" data-bs-target="#application">
							<i class="ti ti-layout-grid-add"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('dashboard', 'companies', 'subscription', 'packages', 'packages-grid', 'domain', 'purchase-transaction', 'tenant-usage-metrics', 'tenant-support-tickets', 'tenant-ticket-details', 'agents', 'sla-policies', 'escalation-rules') ? 'active' : '' }}" title="Super Admin" data-bs-toggle="tab" data-bs-target="#super-admin">
							<i class="ti ti-user-star"></i>
						</a>
						<a href="#" class="nav-link  {{ Request::is('layout-horizontal', 'layout-detached', 'layout-modern', 'layout-two-column', 'layout-hovered', 'layout-box', 'layout-horizontal-single', 'layout-horizontal-overlay', 'layout-horizontal-box', 'layout-horizontal-sidemenu', 'layout-vertical-transparent', 'layout-without-header', 'layout-rtl', 'layout-dark') ? 'active' : '' }}"  title="Layout" data-bs-toggle="tab" data-bs-target="#layout">
							<i class="ti ti-layout-board-split"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('clients-grid', 'projects-grid', 'projects', 'project-details', 'tasks', 'task-board') ? 'active ' : '' }}" title="Projects" data-bs-toggle="tab" data-bs-target="#projects">
							<i class="ti ti-users-group"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('contacts-grid', 'companies-grid', 'deals-grid', 'leads-grid', 'leads-details', 'leads', 'pipeline', 'analytics', 'activity') ? ' show active ' : '' }}" title="Crm" data-bs-toggle="tab" data-bs-target="#crm">
							<i class="ti ti-user-shield"></i>
						</a>
						<a href="#" class="nav-link  {{ Request::is('employees', 'employees-grid', 'employee-details', 'departments', 'designations', 'policy', 'tickets', 'ticket-details', 'ticket-automation', 'ticket-reports', 'holidays', 'leaves', 'leaves-employee', 'leave-settings', 'attendance-admin', 'attendance-employee', 'timesheets', 'schedule-timing', 'overtime', 'holiday-calendar', 'shift-swap-requests', 'work-from-home', 'performance-indicator', 'performance-review', 'performance-appraisal', 'goal-tracking', 'goal-type', 'training', 'trainers', 'training-type', 'certification-tracking', 'learning-analytics', 'probation-management', 'notice-period-tracker', 'promotion', 'resignation', 'termination', 'job-grid', 'job-list', 'candidates-grid', 'candidates-kanban', 'candidates', 'refferals', 'resume-parsing', 'campus-hiring') ? '  active ' : '' }}" title="Hrm" data-bs-toggle="tab" data-bs-target="#hrm">
							<i class="ti ti-user"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('estimates', 'invoices', 'payments', 'expenses', 'provident-fund', 'taxes', 'categories', 'budgets', 'budget-expenses', 'budget-revenues', 'employee-salary', 'payslip', 'payroll', 'payroll-overtime', 'payroll-deduction') ? ' show active ' : '' }}" title="Finance" data-bs-toggle="tab" data-bs-target="#finance">
							<i class="ti ti-shopping-cart-dollar"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('assets', 'asset-categories', 'knowledgebase', 'knowledgebase-details', 'knowledgebase-view', 'users', 'roles-permissions', 'permission', 'expenses-report', 'invoice-report', 'payment-report', 'project-report', 'task-report', 'user-report', 'employee-report', 'payslip-report', 'attendance-report', 'leave-report', 'daily-report', 'profile-settings', 'security-settings', 'notification-settings', 'connected-apps', 'business-settings', 'seo-settings', 'localization-settings', 'prefixes', 'preferences', 'appearance', 'language', 'add-language', 'language-web', 'authentication-settings', 'ai-settings', 'salary-settings', 'approval-settings', 'invoice-settings', 'leave-type', 'custom-fields', 'email-settings', 'email-template', 'sms-settings', 'sms-template', 'otp-settings', 'gdpr', 'maintenance-mode', 'payment-gateways', 'tax-rates', 'currencies', 'custom-css', 'custom-js', 'cronjob', 'storage-settings', 'ban-ip-address', 'backup', 'clear-cache') ? ' active' : '' }}" title="Administration" data-bs-toggle="tab" data-bs-target="#administration">
							<i class="ti ti-cash"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('pages', 'blogs', 'blog-categories', 'blog-comments', 'blog-tags', 'countries', 'states', 'cities', 'testimonials', 'faq') ? 'active' : '' }}" title="Content" data-bs-toggle="tab" data-bs-target="#content">
							<i class="ti ti-license"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('starter', 'profile', 'gallery', 'search-result', 'timeline', 'pricing', 'coming-soon', 'under-maintenance', 'under-construction', 'api-keys', 'privacy-policy', 'terms-condition') ? 'active' : '' }}" title="Pages" data-bs-toggle="tab" data-bs-target="#pages">
							<i class="ti ti-page-break"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('login', 'login-2', 'login-3', 'register', 'register-2', 'register-3', 'forgot-password', 'forgot-password-2', 'forgot-password-3', 'reset-password', 'reset-password-2', 'reset-password-3', 'email-verification', 'email-verification-2', 'email-verification-3', 'two-step-verification', 'two-step-verification-2', 'two-step-verification-3', 'lock-screen', 'error-404', 'error-500') ? '  active' : '' }}" title="Authentication" data-bs-toggle="tab" data-bs-target="#authentication">
							<i class="ti ti-lock-check"></i>
						</a>
						<a href="#" class="nav-link {{ Request::is('ui-alerts', 'ui-accordion', 'ui-avatar', 'ui-badges', 'ui-borders', 'ui-buttons', 'ui-buttons-group', 'ui-breadcrumb', 'ui-cards', 'ui-carousel', 'ui-colors', 'ui-dropdowns', 'ui-grid', 'ui-images', 'ui-lightbox', 'ui-media', 'ui-modals', 'ui-offcanvas', 'ui-pagination', 'ui-popovers', 'ui-progress', 'ui-placeholders' , 'ui-spinner', 'ui-sweetalerts', 'ui-nav-tabs', 'ui-toasts', 'ui-tooltips', 'ui-typography', 'ui-video', 'ui-ribbon', 'ui-clipboard', 'ui-drag-drop', 'ui-rangeslider', 'ui-rating', 'ui-text-editor', 'ui-counter', 'ui-scrollbar', 'ui-stickynote', 'ui-timeline', 'form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-mask', 'form-fileupload', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'form-validation', 'form-wizard', 'form-select2', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'tables-basic', 'data-tables', 'chart-apex', 'chart-js', 'chart-morris', 'chart-flot', 'chart-peity', 'chart-c3', 'icon-fontawesome', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag', 'maps-vector', 'maps-leaflet')? ' active': '' }}" title="UI Elements" data-bs-toggle="tab"
			...
			<div class="sidebar-right">
				...
				<div class="sidebar-scroll">
					...
					<div class="tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade {{ Request::is('index', '/', 'employee-dashboard', 'deals-dashboard', 'leads-dashboard', 'hr-dashboard', 'payroll-dashboard', 'recruitment-dashboard', 'attendance-dashboard', 'finance-dashboard', 'it-admin-dashboard', 'asset-dashboard', 'help-desk-dashboard') ? ' show active ' : '' }}" id="dashboard">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('chat', 'voice-call', 'video-call', 'outgoing-call', 'incoming-call', 'call-history', 'calendar', 'email', 'email-reply', 'todo', 'todo-list', 'notes', 'social-feed', 'file-manager', 'kanban-view', 'invoices', 'add-invoices', 'edit-invoices', 'invoice-details') ? ' show active ' : '' }}" id="application">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('dashboard', 'companies', 'subscription', 'packages', 'packages-grid', 'domain', 'purchase-transaction', 'tenant-usage-metrics', 'tenant-support-tickets', 'tenant-ticket-details', 'agents', 'sla-policies', 'escalation-rules') ? ' show active' : '' }}" id="super-admin">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('clients-grid', 'projects-grid', 'projects', 'project-details', 'tasks', 'task-board') ? 'show active ' : '' }}" id="projects">
							<ul>
								<li class="menu-title"><span>PROJECTS</span></li>
								<li><a href="{{url('clients-grid')}}" class="{{ Request::is('clients-grid') ? 'active' : '' }}">Clients</a></li>
								<li class="submenu">
						...
						<div class="tab-pane fade {{ Request::is('contacts-grid', 'companies-grid', 'deals-grid', 'leads-grid', 'leads-details', 'leads', 'pipeline', 'analytics', 'activity') ? ' show active ' : '' }}" id="crm">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('estimates', 'invoice', 'payments', 'expenses', 'provident-fund', 'taxes', 'categories', 'budgets', 'budget-expenses', 'budget-revenues', 'employee-salary', 'payslip', 'payroll', 'payroll-overtime', 'payroll-deduction') ? ' show active ' : '' }}" id="finance">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('pages', 'blogs', 'blog-categories', 'blog-comments', 'blog-tags', 'countries', 'states', 'cities', 'testimonials', 'faq') ? ' show active' : '' }}" id="content">
							<ul>
						...
						<div class="tab-pane fade {{ Request::is('starter', 'profile', 'gallery', 'search-result', 'timeline', 'pricing', 'coming-soon', 'under-maintenance', 'under-construction', 'api-keys', 'privacy-policy', 'terms-condition') ? ' show active' : '' }}" id="pages">
							<ul>
							...
							<ul>
								...
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="{{url('ui-rating')}}" class="{{ Request::is('rating') ? 'active' : '' }}">Rating</a></li>
										<li><a href="{{url('ui-text-editor')}}" class="{{ Request::is('text-editor') ? 'active' : '' }}">Text Editor</a></li>
										<li><a href="{{url('ui-counter')}}" class="{{ Request::is('counter') ? 'active' : '' }}">Counter</a></li>
										<li><a href="{{url('ui-scrollbar')}}" class="{{ Request::is('scrollbar') ? 'active' : '' }}">Scrollbar</a></li>
										<li><a href="{{url('ui-stickynote')}}" class="{{ Request::is('stickynote') ? 'active' : '' }}">Sticky Note</a></li>
										<li><a href="{{url('ui-timeline')}}" class="{{ Request::is('timeline') ? 'active' : '' }}">Timeline</a></li>
									</ul>
								</li>
								<li class="submenu">
									<a href="javascript:void(0);" class="{{ Request::is('form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-mask', 'form-fileupload', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'form-validation', 'form-wizard', 'form-select2') ? 'subdrop active' : '' }}"> Forms <span class="menu-arrow"></span>
									</a>
									<ul>
										<li class="submenu submenu-two">
						...
						<div class="tab-pane fade" id="extras">
							<ul>
								...
								<li><a href="https://smarthr.dreamstechnologies.com/laravel/documentation/index.html" target="_blank">Documentation</a></li>
								<li><a href="https://smarthr.dreamstechnologies.com/laravel/documentation/changelog.html" target="_blank">Change Log</a></li>
								<li class="submenu">

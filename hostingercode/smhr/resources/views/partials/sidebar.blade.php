			...
			<div id="sidebar-menu" class="sidebar-menu">
				<ul>
					...
					<li>
						<ul>
							<li class="submenu">
								<a href="javascript:void(0);" class="{{ Request::is('index', '/', 'employee-dashboard', 'deals-dashboard', 'leads-dashboard', 'hr-dashboard', 'payroll-dashboard', 'recruitment-dashboard', 'attendance-dashboard', 'finance-dashboard', 'it-admin-dashboard', 'asset-dashboard', 'help-desk-dashboard') ? 'active subdrop' : '' }}">
								...
								<ul>
                                    ...
                                    <li><a href="{{url('hr-dashboard')}}" class="{{ Request::is('hr-dashboard') ? 'active' : '' }}">HR Dashboard <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('payroll-dashboard')}}" class="{{ Request::is('payroll-dashboard') ? 'active' : '' }}">Payroll Dashboard <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('recruitment-dashboard')}}" class="{{ Request::is('recruitment-dashboard') ? 'active' : '' }}">Recruitment Dashboard <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('attendance-dashboard')}}" class="{{ Request::is('attendance-dashboard') ? 'active' : '' }}">Attendance Dashboard <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('finance-dashboard')}}" class="{{ Request::is('finance-dashboard') ? 'active' : '' }}">Finance Dashboard <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('it-admin-dashboard')}}" class="{{ Request::is('it-admin-dashboard') ? 'active' : '' }}">IT Admin Dashboard <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('asset-dashboard')}}" class="{{ Request::is('asset-dashboard') ? 'active' : '' }}">Asset Dashboard <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('help-desk-dashboard')}}" class="{{ Request::is('help-desk-dashboard') ? 'active' : '' }}">Help Desk Dashboard <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
								</ul>
							</li>
							<li class="submenu">
								<a href="javascript:void(0);" class="{{ Request::is('chat', 'voice-call', 'video-call', 'outgoing-call', 'incoming-call', 'call-history', 'calendar', 'email', 'email-reply', 'todo', 'todo-list', 'notes', 'social-feed', 'file-manager', 'kanban-view', 'invoices', 'add-invoices', 'edit-invoices', 'invoice-details') ? 'active subdrop' : '' }}">
							...
							<li class="submenu">
								...
								<ul>
                                    ...
                                    <li><a href="{{url('tenant-usage-metrics')}}" class="{{ Request::is('tenant-usage-metrics') ? 'active' : '' }}">Tenant Usage Metrics <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('tenant-support-tickets')}}" class="{{ Request::is('tenant-support-tickets', 'tenant-ticket-details') ? 'active' : '' }}">Tenant Support Tickets <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li class="submenu submenu-two">
									<a href="#" class="{{ Request::is('agents', 'sla-policies', 'escalation-rules') ? 'active subdrop' : '' }}">Tickets <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span> <span class="menu-arrow inside-submenu"></span></a>
									<ul>
					...
					<li>
						<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="{{ Request::is('projects-grid', 'projects', 'project-details', 'tasks', 'task-board') ? 'active subdrop' : '' }}">
					...
					<li>
						<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="{{ Request::is('tickets', 'ticket-details', 'ticket-automation', 'ticket-reports') ? 'active subdrop' : '' }}">
								...
								<ul>
                                    ...
                                    <li><a href="{{url('ticket-automation')}}" class="{{ Request::is('ticket-automation') ? 'active' : '' }}">Ticket Automation <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('ticket-reports')}}" class="{{ Request::is('ticket-reports') ? 'active' : '' }}">Ticket Reports <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
								</ul>
							</li>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="{{ Request::is('leaves', 'leaves-employee', 'leave-settings', 'attendance-admin', 'attendance-employee', 'timesheets', 'schedule-timing', 'overtime', 'holiday-calendar', 'shift-swap-requests', 'work-from-home') ? 'active subdrop' : '' }}">
								...
								<ul>
                                    ...
                                    <li><a href="{{url('shift-swap-requests')}}" class="{{ Request::is('shift-swap-requests') ? 'active' : '' }}">Shift Swap Requests <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('overtime')}}" class="{{ Request::is('overtime') ? 'active' : '' }}">Overtime</a></li>
                                    <li><a href="{{url('holiday-calendar')}}" class="{{ Request::is('holiday-calendar') ? 'active' : '' }}">Holiday Calendar <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('work-from-home')}}" class="{{ Request::is('work-from-home') ? 'active' : '' }}">WFH Management <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
								</ul>
							</li>
							<li class="submenu">
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="{{ Request::is('training', 'trainers', 'training-type', 'certification-tracking', 'learning-analytics') ? 'active subdrop' : '' }}">
								...
								<ul>
                                    ...
                                    <li><a href="{{url('certification-tracking')}}" class="{{ Request::is('certification-tracking') ? 'active' : '' }}">Certification Tracking <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
                                    <li><a href="{{url('learning-analytics')}}" class="{{ Request::is('learning-analytics') ? 'active' : '' }}">Learning Analytics <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span></a></li>
								</ul>
							</li>
                            <li class="{{ Request::is('probation-management') ? 'active' : '' }}">
                                <a href="{{url('probation-management')}}">
                                    <i class="ti ti-hourglass-empty"></i><span>Probation Management</span> <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span>
                                </a>
                            </li>
                            <li class="{{ Request::is('notice-period-tracker') ? 'active' : '' }}">
                                <a href="{{url('notice-period-tracker')}}">
                                    <i class="ti ti-calendar-stats"></i><span>Notice Period Tracker</span> <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span>
                                </a>
                            </li>
					...
					<li>
						<ul>
							<li class="{{ Request::is('job-grid', 'job-list') ? 'active' : '' }}">
								<a href="{{url('job-grid')}}">
                            ...
                            <li class="{{ Request::is('resume-parsing') ? 'active' : '' }}">
                                <a href="{{url('resume-parsing')}}">
                                    <i class="ti ti-file-search"></i><span>Resume Parsing</span> <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span>
                                </a>
                            </li>
                            <li class="{{ Request::is('campus-hiring') ? 'active' : '' }}">
                                <a href="{{url('campus-hiring')}}">
                                    <i class="ti ti-school"></i><span>Campus Hiring</span> <span class="badge badge-danger fs-10 fw-medium text-white p-1">New</span>
                                </a>
                            </li>
						</ul>
					</li>
					...
					<li>
						<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="{{ Request::is('employee-salary', 'payslip', 'payroll', 'payroll-overtime', 'payroll-deduction') ? 'active subdrop' : '' }}">
					...
					<li>
						<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="{{ Request::is('knowledgebase', 'knowledgebase-details', 'knowledgebase-view') ? 'active subdrop' : '' }}">
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="{{ Request::is('users', 'roles-permissions', 'permission') ? 'active subdrop' : '' }}">
							...
							<li class="submenu">
								...
								<ul>
									<li class="submenu submenu-two">
										...
										<ul>
											<li><a href="{{url('profile-settings')}}" class="{{ Request::is('daily-report') ? 'active' : '' }}">Profile</a></li>
											<li><a href="{{url('security-settings')}}" class="{{ Request::is('daily-report') ? 'active' : '' }}">Security</a></li>
											<li><a href="{{url('notification-settings')}}" class="{{ Request::is('daily-report') ? 'active' : '' }}">Notifications</a></li>
											<li><a href="{{url('connected-apps')}}" class="{{ Request::is('daily-report') ? 'active' : '' }}">Connected Apps</a></li>
										</ul>
									</li>
									<li class="submenu submenu-two">
										<a href="javascript:void(0);" class="{{ Request::is('business-settings', 'seo-settings', 'localization-settings', 'prefixes', 'preferences', 'appearance', 'language', 'add-language', 'language-web', 'authentication-settings', 'ai-settings') ? 'active subdrop' : '' }}">Website Settings<span class="menu-arrow inside-submenu"></span></a>
										<ul>
					...
					<li>
						<ul>
							<li class="submenu">
								...
								<ul>
									<li><a href="{{url('login')}}">Cover</a></li>
									<li><a href="{{url('login-2')}}">Illustration</a></li>
									<li><a href="{{url('login-3')}}">Basic</a></li>
								</ul>
							</li>
							<li class="submenu">
								<a href="javascript:void(0);">
							...
							<li><a href="{{url('lock-screen')}}"><i class="ti ti-lock-square"></i><span>Lock Screen</span></a></li>
							<li><a href="{{url('error-404')}}"><i class="ti ti-error-404"></i><span>404 Error</span></a></li>
							<li><a href="{{url('error-500')}}"><i class="ti ti-server"></i><span>500 Error</span></a></li>
						</ul>
					</li>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li>
										<a href="{{url('ui-scrollbar')}}" class="{{ Request::is('ui-swiperjs') ? 'active' : '' }}">Scrollbar</a>
									</li>
									<li>
					...
					<li>
						<ul>
							...
							<li>
								<a href="https://smarthr.dreamstechnologies.com/laravel/documentation/changelog.html" target="_blank"><i class="ti ti-exchange"></i><span>Changelog</span><span class="badge bg-pink badge-xs text-white fs-10 ms-s">v1.8.0</span></a>
							</li>
							<li class="submenu">

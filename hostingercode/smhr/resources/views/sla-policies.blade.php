        ...
        <div class="content">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
						...
						<div class="mb-2">
							<a href="#" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_modal"><i class="ti ti-circle-plus me-2"></i>Add New Policy</a>
						</div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><p class="text-dark fw-medium mb-0">Critical</p></td>
                                ...
                                <tr>
                                    ...
                                    <td><p class="text-dark fw-medium mb-0">High</p></td>
                                ...
                                <tr>
                                    ...
                                    <td><p class="text-dark fw-medium mb-0">Medium</p></td>
                                ...
                                <tr>
                                    ...
                                    <td><p class="text-dark fw-medium mb-0">Low</p></td>

...
class NewExpenseStatus extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        if ($this->expense->status === 'rejected' && !empty(trim($this->expense->description ?? ''))) {
            $content .= ' ' . __('app.rejectedReason') . ': ' . $this->expense->description;
        }
...
//phpcs:ignore
    public function toArray($notifiable)
    {
        ...
        if ($this->expense->status === 'rejected' && !empty(trim($this->expense->description ?? ''))) {
            $data['reject_reason'] = $this->expense->description;
        }
        return $data;
    }

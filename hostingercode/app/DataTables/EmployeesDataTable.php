...
class EmployeesDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        // For profile card view (hidden columns)
        $datatables->addColumn('image_url', fn($row) => $row->image_url ?? asset('img/default-profile.png'));
        $datatables->addColumn('status_plain', fn($row) => $row->status ?? 'active');
    ...
    protected function getColumns()
    {
        ...
        $data = [
            ...
            'image_url' => ['data' => 'image_url', 'name' => 'image_url', 'visible' => false, 'exportable' => false, 'title' => ''],
            'status_plain' => ['data' => 'status_plain', 'name' => 'status_plain', 'visible' => false, 'exportable' => false, 'title' => ''],
        ];

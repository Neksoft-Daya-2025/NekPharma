...
class LeaveQuotaReportDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addColumn('report_joining_date', function ($row) {
                $ed = $row->employeeDetail;
                return $ed && $ed->joining_date ? Carbon::parse($ed->joining_date)->translatedFormat($this->company->date_format) : '-';
            })
    ...
    public function query(User $model)
    {
        ...
        $model = $model->onlyEmployee()
            ->with('employeeDetail', 'employeeDetail.designation', 'employeeDetail.department', 'employeeDetail.headquarter')

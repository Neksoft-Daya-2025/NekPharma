 ...
 * @property \Illuminate\Support\Carbon|null $manager_approved_at
 * @property-read \App\Models\User|null $managerApprovedBy
 * @method static \Illuminate\Database\Eloquent\Builder|Leave whereManagerApprovedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Leave whereManagerApprovedBy($value)
 * @mixin \Eloquent
 */
class Leave extends BaseModel
{
    ...
    {
        return $this->belongsTo(User::class, 'manager_approved_by')->withoutGlobalScope(ActiveScope::class)->withOut('clientDetails', 'role');
    }

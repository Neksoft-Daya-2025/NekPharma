...
class ClientDetails extends BaseModel
{
    ...
    protected $fillable = ['company_name', 'user_id', 'cfa_distributor_code', 'address', 'postal_code', 'state', 'city', 'office', 'cell', 'website', 'note', 'skype', 'facebook', 'twitter', 'linkedin', 'tax_name', 'gst_number', 'region_id', 'dl_number', 'shipping_address', 'category_id', 'sub_category_id', 'company_logo', 'electronic_address', 'electronic_address_scheme', 'bank_account_name', 'bank_account_number', 'bank_ifsc_code'];
    ...
    {
        return $this->belongsToMany(PharmaArea::class, 'client_areas', 'client_detail_id', 'area_id');
    }

    public function headquarters(): BelongsToMany
    {
        return $this->belongsToMany(PharmaHeadquarter::class, 'client_headquarters', 'client_detail_id', 'headquarter_id');
    }

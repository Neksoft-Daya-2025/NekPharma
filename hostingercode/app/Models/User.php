...
class User extends BaseModel implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract
{
    ...
    {
        return $this->hasOne(EmployeeFnfSettlement::class, 'user_id');
    }
    ...
    // Relationship with CFA Stockists (for CFA/Distributors)
    public function cfaStockists()
    {
        return $this->belongsToMany(CFAStockist::class, 'cfa_distributor_stockist', 'cfa_distributor_id', 'cfa_stockist_id')

...
class CreditNotes extends BaseModel
{
    ...
    protected $fillable = [
        'company_id', 'project_id', 'client_id', 'cn_number', 'invoice_id', 'unit_id',
        'issue_date', 'due_date', 'discount', 'discount_type', 'sub_total', 'total',
        'adjustment_amount', 'currency_id', 'status', 'recurring', 'billing_frequency',
        'billing_interval', 'billing_cycle', 'file', 'file_original_name', 'note',
        'credit_note_type', 'calculate_tax', 'original_credit_note_number',

...
class DashboardWidget extends BaseModel
{
    ...
    const WIDGETS = [
        ...
        // Pharma-specific widgets
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_doctors',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_stockists',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_chemists',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_medical_representatives',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_tours',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'pending_tour_approvals',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'pending_dcr_approvals',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'pending_expense_approvals',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'total_cfa_stockists',  'status' => 1],

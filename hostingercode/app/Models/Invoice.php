...
class Invoice extends BaseModel
{
    ...
    public function cfaDistributorStocks(): HasMany
    {
        return $this->hasMany(CFADistributorStock::class, 'invoice_id');
    }

    public function cfaStockistStocks(): HasMany
    {
        return $this->hasMany(CFAStockistStock::class, 'invoice_id');
    }

    /**
     * Get the CFA Stockist for this invoice (via first stock entry)
     */
    public function getCfaStockistAttribute()
    {
        $firstStock = $this->cfaStockistStocks()->with('cfaStockist')->first();
        return $firstStock ? $firstStock->cfaStockist : null;
    }

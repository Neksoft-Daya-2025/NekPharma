...
class Product extends BaseModel
{
    ...
    protected $fillable = [
        'name', 'price', 'mrp', 'description', 'taxes', 'vendor_id',
        'ptr', 'pts', 'discount', 'discount_type', 'status',
    ];
    ...
    {
        return $this->belongsToMany(Doctor::class, 'doctor_products', 'product_id', 'doctor_id')->withTimestamps();
    }

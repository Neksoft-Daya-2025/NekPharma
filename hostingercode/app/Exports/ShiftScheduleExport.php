...
class ShiftScheduleExport implements FromCollection, WithHeadings, WithMapping, WithEvents
{
    ...
    public function headings(): array
    {
        ...
        $arr[] = __('app.empdate');
        $arr[] = __('app.employeeId');
        $arr[] = __('app.designation');
        $arr[] = __('app.department');
        $arr[] = __('app.dateOfJoining');
        $arr[] = __('app.hq');
    ...
    public function collection()
    {
        ...
        $employees = User::with(
            ['shifts' => function ($query) use ($startDate, $endDate) {
                ...
                }, 'shifts.shift', 'leaves.type', 'employeeDetail.designation', 'employeeDetail.department', 'employeeDetail.headquarter']
        ...
        foreach ($employees as $employee) {
            ...
            $employeedata[$employee_index]['employee_id'] = $employeeDetail->employee_id ?? '-';
            $employeedata[$employee_index]['designation'] = $employeeDetail->designation->name ?? '-';
            $employeedata[$employee_index]['department'] = $employeeDetail->department->team_name ?? '-';
            $employeedata[$employee_index]['joining_date'] = $employeeDetail->joining_date ? $employeeDetail->joining_date->format('d-m-Y') : '-';
            $employeedata[$employee_index]['headquarters'] = $employeeDetail->headquarter->name ?? '-';
    ...
    public function map($employeedata): array
    {
        ...
        $data[] = $employeedata['department'] ?? '-';
        $data[] = $employeedata['joining_date'] ?? '-';
        $data[] = $employeedata['headquarters'] ?? '-';

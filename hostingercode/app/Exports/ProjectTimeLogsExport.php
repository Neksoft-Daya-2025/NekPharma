...
class ProjectTimeLogsExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithColumnFormatting, WithStyles, Responsable
{
    ...
    public function collection()
    {
        ...
        $query = ProjectTimeLog::query()
            ...
            ->with(['user', 'user.employeeDetail.designation', 'user.employeeDetail.department', 'user.employeeDetail.headquarter', 'activeBreak', 'project', 'task'])
    ...
    public function map($log): array
    {
        ...
        $employeeDetail = optional($log->user)->employeeDetail;

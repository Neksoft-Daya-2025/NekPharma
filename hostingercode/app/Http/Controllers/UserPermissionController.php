...
class UserPermissionController extends AccountBaseController
{
    ...
    public function customPermissions(Request $request, $id)
    {
        ...
        // Same list as EmployeeController@show tab=permissions — must match for disabled state
        $employeeModules = array_merge(
        ...
        $this->lockCustomPermissionSelects = ! in_array($this->modulesData->module_name, $employeeModules, true);

...
class RegisterController extends Controller
{
    ...
    public function acceptInvite(AcceptInviteRequest $request)
    {
        ...
        try {
            ...
            if ($user->id) {
                ...
                $employee->employee_id = EmployeeDetails::generateEmployeeId($invite->company_id);
    ...
    /**
     * Complete account setup after registration.
     *
    ...
    public function setupAccount(AccountSetupRequest $request)
    {
        ...
        $employee = new EmployeeDetails();
        $employee->user_id = $user->id;
        $employee->employee_id = EmployeeDetails::generateEmployeeId($setting->id);

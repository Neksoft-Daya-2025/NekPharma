...
class EmployeeController extends AccountBaseController
{
    ...
    public function create()
    {
        ...
        // Generate employee ID in the format "RVB / 100", "RVB / 101", etc.
        $this->generatedEmployeeID = EmployeeDetails::generateEmployeeId();
        
        $this->checkifExistEmployeeId = EmployeeDetails::select('id')->where('employee_id', $this->generatedEmployeeID)->first();

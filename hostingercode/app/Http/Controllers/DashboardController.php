...
use App\Traits\FieldForceDashboard;
...
class DashboardController extends AccountBaseController
{
    ...
    use AppBoot, CurrencyExchange, OverviewDashboard, EmployeeDashboard, ProjectDashboard, ClientDashboard, HRDashboard, TicketDashboard, FinanceDashboard, ClientPanelDashboard, FieldForceDashboard;
    ...
    public function index()
    {
        ...
        // For admin users, use advanced dashboard
        $result = $this->advancedDashboard();
        
        // If advancedDashboard didn't return anything, show overview dashboard
        if ($result === null) {
    ...
    public function advancedDashboard()
    {
        ...
        // Fallback: if not admin, return null (handled by index method)
        return null;
    }

            ...
            <div class="card bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    @foreach (\Modules\Letter\Enums\LetterVariable::cases() as $variable)
                        <div class="col-md-6">
                            <p class="f-10 text-dark-grey f-10 mb-2">
                                <span class="f-12 text-dark d-block mb-1">{{ $variable->label() }}</span>
                                ...
                                <span id="letter-variable-{{ $variable->name }}" class="text-break">{{ $variable->value }}</span>
                            </p>
                        </div>
                    @endforeach
                </div>

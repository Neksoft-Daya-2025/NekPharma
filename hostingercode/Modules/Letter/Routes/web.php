...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    Route::group(
        ...
        function () {
            ...
            Route::get('settings', [\Modules\Letter\Http\Controllers\LetterSettingController::class, 'index'])->name('settings.index');
            Route::post('settings', [\Modules\Letter\Http\Controllers\LetterSettingController::class, 'update'])->name('settings.update');

...
// Recruit Settings
Route::get('recruit-settings/get-template-content', [RecruitSettingController::class, 'getTemplateContent'])->name('recruit-settings.get-template-content');
Route::post('recruit-settings/save-template-content', [RecruitSettingController::class, 'saveTemplateContent'])->name('recruit-settings.save-template-content');
Route::post('recruit-settings/save-offer-letter-content', [RecruitSettingController::class, 'saveOfferLetterContent'])->name('recruit-settings.save-offer-letter-content');

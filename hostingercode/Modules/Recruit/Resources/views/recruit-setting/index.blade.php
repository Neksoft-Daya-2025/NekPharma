                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 offer-letter-template-setting"
                               href="{{ route('recruit-settings.index') }}?tab=offer-letter-template-setting"
                               role="tab"
                               aria-controls="nav-recruit-setting" aria-selected="true"
                               ajax="false">@lang('recruit::app.menu.offerLetterTemplate')
                            </a>
                        </div>
                    </nav>
                </div>

...
class RecruitSetting extends BaseModel
{
    ...
    public function getOfferLetterBgImageUrlAttribute()
    {
        return ($this->offer_letter_background_image) ? asset_url_local_s3('offer-letter-background/' . $this->offer_letter_background_image) : null;
    }

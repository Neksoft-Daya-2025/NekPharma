...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::get('payroll/attendance-finalisation-status', [PayrollController::class, 'attendanceFinalisationStatus'])->name('payroll.attendance-finalisation-status');
    ...
    Route::get('payroll/download-deduction-sample', [PayrollController::class, 'downloadDeductionSample'])->name('payroll.download-deduction-sample');

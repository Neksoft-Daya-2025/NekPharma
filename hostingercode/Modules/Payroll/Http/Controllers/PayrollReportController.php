...
use Modules\Payroll\Exports\IncrementReportExport;
...
class PayrollReportController extends AccountBaseController
{
    ...
    public function exportReport(Request $request)
    {
        ...
        if ($type == 'increment') {
            $start = $startDate ? Carbon::createFromFormat('m-Y', $startDate)->startOfMonth()->format('Y-m-d') : null;
            $end = $endDate ? Carbon::createFromFormat('m-Y', $endDate)->endOfMonth()->format('Y-m-d') : null;
            return Excel::download(
                new IncrementReportExport($start, $end, $departmentId, $designationId),
                'increment_report.xlsx'
            );
        }

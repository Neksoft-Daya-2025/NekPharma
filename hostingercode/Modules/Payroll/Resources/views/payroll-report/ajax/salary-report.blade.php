    ...
    <div class="d-flex flex-column">
        <div class="row mb-4">
            <div class="col-lg-12 d-flex justify-content-center">
                ...
                <div class="border-top-grey justify-content-center px-4 py-3">
                    <a href="javascript:;" onclick="downloadReport('increment')">
                        <x-forms.button-secondary id="increment-report"
                                                icon="download">{{ __('payroll::modules.payroll.increment') }} Report
                        </x-forms.button-secondary>
                    </a>
                </div>
            </div>

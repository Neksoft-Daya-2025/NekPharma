...
class PayrollDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->editColumn('pay_days', function ($row) {
                return isset($row->pay_days) && $row->pay_days > 0 ? $row->pay_days : '--';
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            __('payroll::modules.payroll.payDays') => ['data' => 'pay_days', 'name' => 'pay_days', 'title' => __('payroll::modules.payroll.payDays')],

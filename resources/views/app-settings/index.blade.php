                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 employee-setting"
                               href="{{ route('app-settings.index') }}?tab=employee-setting" role="tab"
                               aria-controls="nav-employeeSettings" aria-selected="true"
                               ajax="false">Employee Settings
                            </a>
                        </div>
                    </nav>
                </div>

@php
    ...
    $canViewLedger = in_array('accountant', user_roles()) || in_array('admin', user_roles()) || in_array('fsa-executive', user_roles()) || $isClientDistributor || (in_array('invoices', user_modules()) && in_array(user()->permission('view_invoices'), ['all', 'added', 'owned', 'both']));

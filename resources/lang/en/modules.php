...
return array(
    'dashboard' => array(
        'totalClients' => 'Total CFA / Distributors',
        'newClients' => 'New CFA / Distributors',
        ...
        'totalConvertedClient' => 'Total CFA / Distributor Convert',
        ...
        'clientFeedback' => 'CFA / Distributor Feedback',
        'settingsLeaves' => 'Leaves Calendar',
        'totalDoctors' => 'Total Doctors',
        'totalStockists' => 'Total Stockists',
        'totalChemists' => 'Total Chemists',
        'totalMedicalRepresentatives' => 'Medical Representatives',
        'totalTours' => 'Total Tours',
        'pendingTourApprovals' => 'Pending Tour Approvals',
        'pendingDcrApprovals' => 'Pending DCR Approvals',
        'pendingExpenseApprovals' => 'Pending Expense Approvals',
        'totalCfaStockists' => 'Total CFA Stockists',
        'quickActions' => 'Quick Actions',
        'submitDcr' => 'Submit DCR',
        'submitTourPlan' => 'Submit Tour Plan',
        'submitExpense' => 'Submit Expense',
        'approveTourPlans' => 'Approve Tour Plans',
        'approveDcr' => 'Approve DCR',
        'approveExpenses' => 'Approve Expenses',
        'companyCfaLedger' => 'Company CFA Ledger',
        'cfaStockistLedger' => 'CFA Stockist Ledger',
        'totalActiveClients' => 'Active CFA / Distributors',
        'totalContractsSigned' => 'Contracts Signed',
        'totalContractsGenerated' => 'Contracts Generated',
        'totalLeadConversions' => 'Deal Conversions',
        'latestClient' => 'Latest CFA / Distributors',
        'recentLoginActivities' => 'Recent Login Activities',
        'clientWiseEarnings' => 'CFA / Distributor Wise Earnings',
        'clientWiseTimelogs' => 'CFA / Distributor Wise Timelogs',
        ...
        'earningsByClient' => 'Earnings By CFA / Distributor',
    ...
    'client' => array(
        ...
        'visibleToClient' => 'Visible To CFA / Distributor',
        'askToReenterPassword' => 'Ask to re-enter password',
        'createTitle' => 'Add CFA / Distributor Info',
        'companyDetails' => 'Company Details',
        'companyName' => 'CFA / Distributor Name',
        'website' => 'Official Website',
        'address' => 'Address',
        'clientDetails' => 'CFA / Distributor Details',
        'clientBasicDetails' => 'CFA / Distributor Basic Details',
        'clientOtherDetails' => 'Other Details',
        'clientName' => 'Owner Name',
        'clientEmail' => 'CFA / Distributor Email',
        'clientPhone' => 'CFA / Distributor Phone',
        'emailNote' => 'CFA / Distributor will login using this email and email notifications will be sent to this email.',
        'password' => 'Password',
        'passwordNote' => 'CFA / Distributor will login using this password.',
        'passwordUpdateNote' => 'Leave blank to keep the current password.',
        'mobile' => 'Mobile',
        'updateTitle' => 'Update CFA / Distributor Info',
        'addNewClient' => 'Add New CFA / Distributor',
        ...
        'sendCredentialsMessage' => 'Do you want to send credentials via E-mail to the CFA / Distributor ?',
        'assignProject' => 'Assign Project',
        'cell' => 'Cell',
        'officePhoneNumber' => 'Office Phone Number',
        'addedOn' => 'Added On',
        'clientCategory' => 'CFA / Distributor Category',
        'clientSubCategory' => 'CFA / Distributor Sub Category',
    ...
    'employees' => array(
        ...
        'attendanceSourceOffice' => 'Office',
        'attendanceSourceField' => 'Field',
        'employeeOnboardingFlow' => 'Employee Onboarding',
        'employeeOnboardingDescription' => 'Add new employees with full master data: Employee ID, Assigned HQ, Bank & Identity (Aadhaar, PAN, UAN), Addresses, and Employment Status.',
        'startOnboarding' => 'Add Employee (Onboarding)',
        ...
        'trainee' => 'Trainee',
        'territoryMappingTitle' => 'Territory mapping',
        'territoryMappingHelp' => 'Reporting chain and territory assigned from the employee record (read-only).',
        'territoryMappingReportingChain' => 'Reporting chain (top to bottom)',
        'territoryMappingAssignedGeography' => 'Assigned geography (from employee record)',
        'territoryFlowZones' => 'Assigned zones',
        'territoryFlowRegions' => 'Assigned regions',
        'territoryFlowAreas' => 'Assigned areas',
        'territoryMappingHeadquarter' => 'Headquarter',
        'territoryMappingNone' => 'Not assigned',
        'activities' => [
    ...
    'expenses' => array(
        ...
        'downloadApprovedExcel' => 'Download approved (Excel)',
        'approvedExpensesExportHint' => 'Approved expense statement lines only, for the selected month and filters.',
    ),
    ...
    'attendance' => array(
        ...
        'attendanceManagementFlow' => 'Attendance Management',
        'attendanceManagementDescription' => 'Office employees: manual or system clock-in/clock-out. Field employees: attendance is marked only when DCR is closed for the day (no manual entry). Finalise monthly attendance to enable payroll for that month.',
        'finaliseAttendance' => 'Finalise Attendance',
        'attendanceFinalised' => 'Finalised',
    ...
    'leaves' => array(
        ...
        'addLeave' => 'New Leave',
        'leaveManagementFlow' => 'Leave Management',
        'leaveManagementDescription' => 'Leave types (CL, EL, SL) with auto-calculated balance. Approval flow: Employee → Reporting Manager → HR. Leave report available with Export to Excel and Print.',
        'applyLeave' => 'Apply for Leave',
        'viewLeaveReport' => 'Leave Report',
        ...
        'managerApprovedBy' => 'Manager Approved By',
        'managerApprovedAt' => 'Manager Approved At',
    ...
    'lead' => array(
        ...
        'all' => 'All',
        'lead' => 'Lead',
        'client' => 'CFA / Distributor',
        'pending' => 'Pending',
        'changeToClient' => 'Change To CFA / Distributor',
    ...
    'module' => array(
        ...
        // Pharma Field Force Modules
        'doctors' => 'Doctors',
        'chemists' => 'Chemists',
        'stockists' => 'Stockists',
        'sfc' => 'SFC Charts',
        'pharma_areas' => 'Area Management',
        'tours' => 'Tour Planning',
        'dcr_reports' => 'DCR Reports',
        'cfa' => 'CFA Management',
    ),
    ...
    'chemists' => array(
        ...
        'editChemist' => 'Edit Chemist',
        'chemistDetails' => 'Chemist Details',
        'shopName' => 'Shop Name',
        'contactPerson' => 'Contact Person',
        'chemistPicture' => 'Chemist Picture',
    ),
    
    'stockists' => array(
        'title' => 'Stockists',
        'addStockist' => 'Add Stockist',
        'editStockist' => 'Edit Stockist',
        'stockistDetails' => 'Stockist Details',
        'shopName' => 'Shop Name',
        'contactPerson' => 'Contact Person',
        'stockistPicture' => 'Stockist Picture',
    ),
    ...
    'pharma_areas' => array(
        ...
        // HeadQuarter Permissions
        'addHeadquarter' => 'Add HeadQuarter',
        'viewHeadquarters' => 'View HeadQuarters',
        'editHeadquarter' => 'Edit HeadQuarter',
        'deleteHeadquarter' => 'Delete HeadQuarter',
        'headquarterName' => 'HeadQuarter Name',
        
        // Ex-Station Permissions
        'addExstation' => 'Add Ex-Station',
        'viewExstations' => 'View Ex-Stations',
        'editExstation' => 'Edit Ex-Station',
        'deleteExstation' => 'Delete Ex-Station',
        
        // Out-Station Permissions
        'addOutstation' => 'Add Out-Station',
        'viewOutstations' => 'View Out-Stations',
        'editOutstation' => 'Edit Out-Station',
        'deleteOutstation' => 'Delete Out-Station',
        'stationName' => 'Station Name',
        
        // Assignment Permissions
        'assignRegions' => 'Assign Regions',
        'assignAreas' => 'Assign Areas',
        'assignHeadquarters' => 'Assign HeadQuarters',
        'manageAreaAssignments' => 'Manage Area Assignments',
    ),
    
    'tours' => array(
        'title' => 'Tour Planning',
        'addTour' => 'Add Tour Plan',
        'editTour' => 'Edit Tour Plan',
        'tourDetails' => 'Tour Details',
        'tourPlan' => 'Tour Plan',
        'monthlyPlan' => 'Monthly Tour Plan',
        ...
        'tourPending' => 'Pending Approval',
    ),
    
    'dcr_reports' => array(
        'title' => 'DCR Reports',
        'addReport' => 'Add DCR Report',
        'editReport' => 'Edit DCR Report',
        'reportDetails' => 'Report Details',
        'dailyCallReport' => 'Daily Call Report',
        'reportingDate' => 'Reporting Date',
        'doctorVisit' => 'Doctor Visit',
        'chemistVisit' => 'Chemist Visit',
        'stockistVisit' => 'Stockist Visit',
        'productDiscussed' => 'Product Discussed',
        'pob' => 'POB (Potential of Business)',
        'rcpa' => 'RCPA',
        'remarks' => 'Remarks',
